...
},
{
  ...
  "number": "1.1.1",
  "title": "Proposition.",
  "body": " Proposition  proposition  A proposition is a sentence that can take only one of two values: true or false.  "
},
{
  "id": "prop-example",
  "level": "2",
...
{
  "id": "sec-2-2-1-conditional-9",
  "level": "2",
  "url": "sec-2-2-conditionals.html#sec-2-2-1-conditional-9",
  "type": "Example",
  "number": "1.2.3",
  "title": "",
  "body": " Consider the following propositions   : Blueberries are on sale   : I will buy blueberries   : If Blueberries are on sale then I will buy blueberries  When I tell my wife before I go to the store, when am I lying to her?  There are a couple of cases:   Blueberries are on sale:   When I buy the blueberries I am telling the truth  When I do not buy the blueberries I am lying!       Blueberries are not on sale:   When I buy blueberries, I'm telling the truth because I never said I wasn't going to buy them, maybe I am really really craving them!    When I don't buy blueberries, I'm still telling the truth because when they are not on sale I am under no obligation to buy them!        "
},
{
...
},
{
  ...
  "number": "1.4.6",
  "title": "Logic Laws.",
  "body": " logic laws  logic laws double negation  logic laws commutativity  logic laws distributive  logic laws absorption  logic laws DeMorgan's  logic laws associativity  logic laws contrapositive  logic laws Rob's Law  double negation  commutativity  distributive  absorption  DeMorgan's  associativity  contrapositive  Rob's Law  Logic Laws               Double negation Law                  Commutativity Laws          Distributivity Laws          Absorption Laws          DeMorgan's Law          Associativity Laws             Contrapositive             Rob's Law      "
},
{
...
},
{
  ...
  "number": "1.5.4",
  "title": "",
  "body": " The open statements and are equivalent in the universe but they again are not equivalent in the universe   For the truth set for both and is   Yet, for the truth set for is but the truth set for is still .  "
},
{
  "id": "def-exists",
  "level": "2",
...
},
{
  ...
  "number": "1.5.12",
  "title": "",
  "body": "   Every Indiana resident at least 18 years old, can vote     Some functions defined at 0 are not differentiable at zero     Some students are math majors and some students are business majors     Some Students major in math and accounting.     "
},
{
  "id": "sec-1-4",
  "level": "1",
...
},
{
  "id": "ex-validness",
  "level": "2",
  "url": "sec-3-1-arguments.html#ex-validness",
  "type": "Example",
  "number": "2.1.4",
  "title": "",
...
},
{
  "id": "def-sound",
  "level": "2",
  "url": "sec-3-1-arguments.html#def-sound",
  "type": "Definition",
  "number": "2.1.5",
  "title": "Sound.",
  "body": " sound  argument sound  Sound   We say that an argument is sound when it is valid as well as the premises are true.   "
},
{
...
},
{
  ...
  "number": "2.2.3",
  "title": "",
  "body": " We now have enough to explain the why behind some of our examples from . First the example of:    All parabolas are functions of degree 2    All functions of degree 2 are quadratic    All parabolas are quadratic    This can be written with logical connectives in the fashion of:    parabola function of degree 2    function of degree 2 quadratic    parabola quadratic    This can now be seen as an simple application of Hypothetical Syllogism.  The next example from     An apple is purple    An apple is a fruit    An apple is purple fruit    written with logical connectives would be    An apple is purple    An apple is a fruit    An apple is purple and an apple is a fruit    so we see this an application of Conjunction.  Further, another example from     All spiders have 8 legs    A poodle is a spider    A poodle has 8 legs    again, using logical connectives can be seen as    spiders 8 legs    A poodle spider    A poodle 8 legs    which is again a direct application of Hypothetical Syllogism.  "
},
{
  "id": "sec-3-2-prop-forms-16",
  "level": "2",
  "url": "sec-3-2-prop-forms.html#sec-3-2-prop-forms-16",
  "type": "Example",
  "number": "2.2.4",
  "title": "",
...
},
{
  ...
  "number": "3.4.2",
  "title": "",
  "body": "  Prove: For all integers and if and are both odd then is odd.  Select two random integers and . Assume that is odd and is also odd. By definition of even we can find an integer so that . Also, by the definition of odd we can find an integer so that . Now we calculate:   Now since is an integer, we see that is odd.  To summarize, since we chose arbitrary integers and which we assumed were both odd, respectively, by direct proof we proved that for all integers and , if is odd and is odd, then is odd.   "
},
{
...
},
{
  ...
  "number": "7.1.6",
  "title": "Range.",
  "body": " Range  relation range  range   The range of a relation from to is the set    "
},
{
  "id": "ex-dom",
  "level": "2",
