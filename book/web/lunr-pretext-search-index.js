...
},
{
  ...
  "body": " Propositions and Connectives   I have heard many students say things like \"I'm a math major not an English major\". This sentiment becomes further and further from the truth as you continue your journey in the major of mathematics. For one, you begin to see mathematics as a language itself with its own gammar and rules, and inparticular in this course you begin to only write paragraphs in exhange for the string of symbols and numbers from your calculus courses. As we begin our journey into abstract mathematics we need to do the exact opposite of this sentiment, and instead examine how language works, specifically how language handles truth.  In English, as in many languages, there are many types of sentences, some more complicated than others. We will now be concerning ourselves with if a sentence is true. This is the hallmark of proving, by only writting sentences that are true, so that our conclusions are then true.    Propositions and Negation  Even though many statements\/sentences can be true or can be false, it doesn't make sense to say that any sentence that you could write is true or not. For example a question such as \"Where is my phone?\" or an exclamation like \"Oh No!\" . Both of these examples are indeed complete sentences, as in they express a complete thought, but are neither true nor false.   Proposition  proposition  A proposition is a sentence that can take only one of two values: truth or false.     Some Examples of Propostions  proposition  The following are examples of propositions:    The gazel will become the only living animal on earth by the year 2525.  Galileo Galilei had bacon on his eleventh birthday.    Some propositions, like (A) in have clear truth values, that is we can easily determine if the statement is either True or False (but not both). Perhaps, to untangle the last sentence, it is clear that (A) in is False.  Yet, the remaining (B) and (C) in , cannot be easily determined if they are True or False (unless of course you are reading this after 2525) but nonetheless they are either True or False (and not both) whether or not we can determine which one.    Some Examples of Sentences that are not Propositions  The following are sentences that are NOT propositions:   Stop!  She has my phone.   This sentence is false.      paradox For examples (B) and (C) in are not propositions because (B) depends on who \"She\" is to determine its truth value, while in (C) it depends on what \" \" is, for example when is 2 it is True, but when is 3 it is False. Example (A) from is an exclamation and is neither True nor False. Finally, (D) from is known as a paradox . If the statement “This sentence is false” is true, then by its meaning it must be false. On the other hand, if the given statement is false, then what it claims is false, so it must be true.  In our journey of learning propositional logic we will often find it necessary to discuss arbitrary propostions. To do so we will try and use capital letters such as: , , , , and .  There are many ways to create new propositions from old ones. Our first tool to do just that is the logical negation .     Negation  negation  Given a proposition ,   The negation of , denoted , is the propositon  \" not  \"   is true exactly when is false.     It is noteworthy that the symbol can be found in many texts for the negation as well. The negation is simply the opposite of the propostion.    Some Negation Examples  negation      : The sky is purple.   : The sky is not purple.     : It is raining right now at SMWC.   : It is not raining right now at SMWC.         Connectives and Compound Propositions   simple  compound  atomic In the propositions are all simple or atomic in the sense that they do not have any other propositions as components. Compound propositions can be formed by using connective words, connecting more than one propostion.    Conjunction  conjunction  and  Given propositions and ,   The conjunction of and , denoted , is the proposition:  \"  and  \"   is true exactly when both  and are true!    We will see throughout this course that many different words in English can be used for our propostions with the same meaning. For example, but, while, and although are usually translated symbolically with the conjunction connective. An example of this, using the propositions from (A) in , is we could write \"It is not raining outside but I do have my umbrella\" symbolically as \" \".    Some Conjunction Examples  conjunction  and    : \"It is raining outside.\"  : \"I have an umbrella.\"  : It is raining outside and I have an umbrella.     : \"Leonardo di ser Piero da Vinci was born in Italy.\"   : \" is rational.\"   : \"Leonardo di ser Piero da Vinci was born in Italy and is rational.\"     : \"DNA stores information about how to build cells\"   : \"Archaea are prokaryotes\"   : \"DNA stores information about how to build cells and Archaea are prokaryotes\"        Disjunction  disjunction  or  Given propositions and ,   The disjunction of and , denoted , is the proposition:  \"  or  \"  is true exactly when at least one of  or are true.     inclusive or  exclusive or The logical disjunciton is often reffered to as the inclusive or , as it is still true when both propositions are true. In English we often assume the use of the exclusive or , that is, when we use the word or we most often mean only one of two choices. For example \"would you like chicken or steak\". When someone says this to you, you know immedately they do not mean that you can have both chicken and steak, that is not the case for the logical disjunction.    Some Disjunction Examples  disjunction  or      : 10 is a composite.   : 4 is a prime.   : 10 is a composite or 4 is prime.    : \"I will do my homework.\"  : \"I will watch Star Wars.\"  : \"I will do my homework or I will watch Star Wars.\"    : \"I will do the dishes tonight.\"  : \"I am cooking tonight.\"  : \"I will do the dishes tonight or I am tonight.\"         "
},
{
...
},
{
  ...
  "body": " Some Disjunction Examples  disjunction  or      : 10 is a composite.   : 4 is a prime.   : 10 is a composite or 4 is prime.    : \"I will do my homework.\"  : \"I will watch Star Wars.\"  : \"I will do my homework or I will watch Star Wars.\"    : \"I will do the dishes tonight.\"  : \"I am cooking tonight.\"  : \"I will do the dishes tonight or I am tonight.\"     "
},
{
  ...
  "body": " Conditionals and Biconditionals   complete In the last section we saw a few connectives. Using only these connectives is possible and is all you need for a complete logical system, but it ignores an important decree used quite often in logic\/debate\/mathematics. That is the implilcation.   Conditionals   Conditional  conditional  Given a propositions and ,   the conditional statment  is the propostion  \"If then \"  Propostion is called the antecedent and is the consequent .  The conditional statement is true exactly when is false or is true.     implies There are many ways of translating the conditional to english statments, which we will in the next table but perhaps the most popular is implies , that is \" implies \".     :  Example:    If then   If I am cooking tonight then I will do dishes     implies   The water temperature is C implies the water is boiling     is sufficient for  The water temperature is C is sufficent for the water is boiling     only if  I am cooking tonight only if I will do the dishes     , if   The water is boiling if the water temperature is C     whenever   The water is boiling whenever the water temperature is C     is necessary for   The water is boiling is necessary for the water temperature is C     when   The water is boiling when the water temperature is C    Since we get   Since we have seen that 4 is even we get that 2 divides 4.    I have found the truth values of this connective to be the most challenging for students. To help I suggest the student always think of the next example.    The Lying Politician  implies  conditional  lying politician   : If I am elected   : I will lower taxes   : If I am elected then I will lower taxes.  So when is politician lying?  There are a couple of cases:   The politiciian is indeed elected:    The politician lowers taxes!  The politiciian is not lying!    The politician does not lower taxes  The politiciain is lying!      The politician is not elected:    The politician works hard with community leaders and lobbies to get taxes lowered  The politician is not lying!    The politician sits on their couch all day eating Fruit Loops, and taxes are not lowered  The politician is not lying!         Students seem to have the hardes time seeing that when the politician is not elected their is no obligation to do anything and hence the politician is not lying!    Biconditionals   Biconditional  biconditional  Given a propositions and ,   the biconditional statment  is the propostion  \" if and only if \"  The biconditional statement is true exactly when and have the same truth value.     iff  if and only if  biconditional Instead of writting \"if and only if\" we will often elect to only type \"iff\" . Just as with the implication, the biconditional has many english translations:     :  Example:     if and only if   I will buy dinner if and only if you buy the movie tickets     if, but only if   The water temperature is C if, but only if the water is boiling     is equivalent to  The water temperature is C is sufficent for the water is boiling     is necessary and sufficent for  I am cooking tonight is necessary and sufficent for you to do the dishes    It is this biconditional that I believe many students hear when they hear the phrase: \"If I am elected then I will lower taxes\". When indeed they mean \"Taxes will be lowered if, but only if I am elected\".   "
},
{
...
},
{
  ...
  "number": "1.2.1",
  "title": "Conditional.",
  "body": " Conditional  conditional  Given a propositions and ,   the conditional statment  is the propostion  \"If then \"  Propostion is called the antecedent and is the consequent .  The conditional statement is true exactly when is false or is true.   "
},
{
...
},
{
  ...
  "number": "1.2.1",
  "title": "Biconditional.",
  "body": " Biconditional  biconditional  Given a propositions and ,   the biconditional statment  is the propostion  \" if and only if \"  The biconditional statement is true exactly when and have the same truth value.   "
},
{
  ...
  "number": "1.3",
  "title": "Truth Tables",
  "body": " Truth Tables   So far we have always looked at actual sentences, even when a letter like was introduced it was immediately followed by an actual statement.  To recall our journey is to show\/find the truth of statements, most often refferred to as proofs. In this journey we will need to combine propositons which we already know their truth value to arrive at new propositions which we want to be true. To be able to do this we need to be able to know how combining different propositons with our connectives effect their truth value (truthiness). To keep track of this we now introduce truth tables.     Basic Tables   truth table In a truth table we take arbitirary propositions indicated by letters, such as , , , , and , and consider all the cases of each being either True (T) or False (F). We then explore how comining them with connectives changes the truth value of the compound propositions.   propositional forms We will call these arbitrary propositions\/compound propostions, propositional forms . These propositoinal forms do not have a truth value. Instead, each form has a list of truth values that depend on the values assigned to its components. This list is displayed by presenting all possible combinations for the truth values of its components in a truth table.  To do this we will need to first be able to collect all the combinations of truth values of the basic components of a compound proposition. So for example, if the compound proposition has to components, lets name them and then all combinations are:         T  T    T  F    F  T    F  F     Now to see everything together we will begin with a couple of simple ones, first the conjunciton ( ). Since the conjunction involves two components ( and ) their truth tables must include all combinations of their two truth values, just as collected above in figure .   conjunction  truth table         T  T  T    T  F  F    F  T  F    F  F  F     Next the disjunction ( ). Since the disjunction also only involves two components ( and ) their truth tables must again include all combinations of their two truth values, just as collected above in .   disjunction truth table         T  T  T    T  F  T    F  T  T    F  F  F     Next, we will see the truth table for the negation, . Since the negation only invovles one component ( ) we simply need the two truth values that can obtain.   negation truth table        T  F    F  T     Now, we see the implication, in action. Again this has two components so we must list them all.   implies truth table  conditional truth table         T  T  T    T  F  F    F  T  T    F  F  T          ~     T  T  F  T    T  F  F  T    F  T  T  T    F  F  T  F     An importatant one is that of the biconditional, which we use as the word equivalent, this table shows us that this is a apt word use.   iff truth table  if and only if truth table  biconditional truth table         T  T  T    T  F  F    F  T  F    F  F  T       More Complicated Tables  Now lets dive into more complicated examples. As our examples get more complicated, I suggest that the student take time to break-it-down. That is to create extra columns that are themseleves components of compoud propositions. A simple example of this is the compound proposition: This example has only two basic compounants, namely and . Yet, notice that the antecedent is , this is what I suggest you create a new column for namely after you make your column and you column, then before you make your final column add a column           T  T  F     T  F  F     F  T  T     F  F  T      Next, you can complete you table only looking at the and columns as they are the only ones now involved in the compound proposition            T  T  F  T    T  F  F  T    F  T  T  T    F  F  T  F     For an even more complicated example consider: This has two major pieces namely as well as . Again the atomic pieces are and so we begin with our standard two columns, then we include a column for each of these major pieces:           T  T  T  T    T  F  T  F    F  T  T  F    F  F  F  F     Now recall that we are trying to build a table for . The next major piece we see is that of             T  T  T  T  F    T  F  T  F  T    F  T  T  F  T    F  F  F  F  T     Finally, we can simply look at the cells as well as to finish our table for:              T  T  T  T  F  F    T  F  T  F  T  T    F  T  T  F  T  T    F  F  F  F  T  F     From now on we will only show the finished tables.  Another way of making a more complicated table is to have a compound proposition which invovlves three atomic propositions: , , and . In this case all of the possible combinations of true and false are the following:          T  T  T    T  T  F    T  F  T    T  F  F    F  T  T    F  T  F    F  F  T    F  F  F     Now we can do an example like             T  T  T  T  T    T  T  F  F  T    T  F  T  T  F    T  F  F  F  T    F  T  T  F  T    F  T  F  F  T    F  F  T  F  T    F  F  F  F  T       Tautologies and Contradictions  One of the strongest tools in proving are propositonal statements that are either always true or always false.   Tautology  tautology   A tautology is a propositional form that is true for any assignment of truth value to its components     law of the excluded middle One of the most famous, and most meme'd is the Law of the Excluded Middle , , which is a tautology. It is the classic \"to be or not to be\", \"today I will do my homework or I will not\". We can use a truth table to see that this statement is always true.          T  F  T    F  T  T     Another example, that may not immediately be as obvious is for               T  T  T  F  F  F  T    T  F  T  F  T  F  T    F  T  T  T  F  F  T    F  F  F  T  T  T  T      Contradiction  contradiction   A contradiction is a propositional form that is false for any assignment of truth value to its components    For an example of a contradition is the famous , this is the classic \"I go to bed early and I will not go to bed early\".          T  F  F    F  T  F     Another example of a contradiction is: , that is of course just a negation of a tautology.           T  F  T  F    F  T  T  F      "
},
{
...
},
{
  ...
  "body": " Logical Equivalences   In this course students will often treat this beginning material of propositions and truth tables as not connected to the proofs, and just a way to get some good grades on early homework. I cannot blaim the student for this, when thrown into an unknown world it is hard to hold on-to everything.  Yet, we will now dive into equivalences. In the world of proving it may often be difficult to prove a statement how it appears in the homework, or how you first discovered it, but if you were to simply re-word it, now it becomes simplier to prove. These rewordings are the equivalences.     What is an equivalence?   Logically Equivalent  equivalent logically equivalent   Two propostional forms are logically equivalent (or just equivalent ) if and only if they have the same truth values.    The notation, we will use, for two propositonal forms begin equivalent is:   To show that two propositional forms are indeed equivalent at the begininng we only have the tool of truth tables at our disposal. What we will see in this first example is that no matter our choic of truth value for that we have the same truth value, that is    double negation          T  F  T    F  T  F      For another example lets see if             T  T  T  F  T    T  F  F  F  F    F  T  T  T  T    F  F  T  T  T     Thus we see that the truth values are the same for and !     Some Important Equivalences  There are a number of logical equivalences that are very important to become familiar with. We will build some of these truth tables for you, and leave the rest for exercises.    Augustus De Morgan   Augustus De Morgan (27 June 1806 - 18 March 1871) was a British mathematician and logician. He is best known for De Morgan's laws, relating logical conjunction, disjunction, and negation, and for coining the term \"mathematical induction\", the underlying principles of which he formalized. De Morgan's contributions to logic are heavily used in many branches of mathematics, including set theory and probability theory, as well as other related fields such as computer science.  *information from Wikipedia*    logic laws  logic laws dounble negation  logic laws commutivitiy  logic laws distributive  logic laws absorption  logic laws DeMorgan's  logic laws associativity  logic laws contrapositive  logic laws Rob's Law  dounble negation  commutivitiy  distributive  absorption  DeMorgan's  associativity  contrapositive  Rob's Law               Double negation Law                  Commutativity Laws          Distributivity Laws          Absorption Laws          DeMorgan's Law          Associativity Laws             Contrapositive             Rob's Law        We saw the double negation law in .  Next we will build the truth tables for two important ones, namely Rob's Law and contrapositive, then leave the rest as an exercise.   contrapositive truth table            T  T  T  F  F  T    T  F  F  F  T  F    F  T  T  T  T  T    F  F  T  T  T  T      Rob's Law truth table            T  T  T  F  T    T  F  F  F  F    F  T  T  T  T    F  F  T  T  T        The Algebra of Logic  Now that we have established the laws in we have a new way to prove two propositional forms are equivalent. It is what I playfully refer to as the algebra of logic.   For a first example of this lets see a proof that       There are many examples for you to try in this chapter's exercises, but we will leave you with one more example.           "
},
{
  "id": "def-equiv",
  "level": "2",
  ...
  "body": " Logically Equivalent  equivalent logically equivalent   Two propostional forms are logically equivalent (or just equivalent ) if and only if they have the same truth values.   "
},
{
...
},
{
  ...
  "number": "1.4.1",
  "title": "",
  "body": " logic laws  logic laws dounble negation  logic laws commutivitiy  logic laws distributive  logic laws absorption  logic laws DeMorgan's  logic laws associativity  logic laws contrapositive  logic laws Rob's Law  dounble negation  commutivitiy  distributive  absorption  DeMorgan's  associativity  contrapositive  Rob's Law               Double negation Law                  Commutativity Laws          Distributivity Laws          Absorption Laws          DeMorgan's Law          Associativity Laws             Contrapositive             Rob's Law      "
},
{
  ...
  "number": "1.4.2.1",
  "title": "",
  "body": " We saw the double negation law in .  Next we will build the truth tables for two important ones, namely Rob's Law and contrapositive, then leave the rest as an exercise.   contrapositive truth table            T  T  T  F  F  T    T  F  F  F  T  F    F  T  T  T  T  T    F  F  T  T  T  T      Rob's Law truth table            T  T  T  F  T    T  F  F  F  F    F  T  T  T  T    F  F  T  T  T     "
},
{
  ...
  "number": "1.4.1",
  "title": "",
  "body": " For a first example of this lets see a proof that      "
},
{
...
},
{
  ...
  "number": "1.5",
  "title": "Quantifiers",
  "body": " Quantifiers    predicate It is now time to take care of those statments that were not propositons from , but have propably been bugging you this whole time like: , which are known as an open statment or predicate . But, how on earth are we to do mathematics and these sentences not be in our lexicon? To handle these we need to quantify the , by saying we can find a number so that . Before quantifying the statement you didn't even need to assume was a number!  \"But Dr. Rob I could tell was a number by context!\"  But, what context was that? Was it that this is a math class and I'm a math professor? Even so, what kind of number? A rational number (fractions)? A positive number? An imaginary number?     The Universe of Discourse   universe of discourse As many of you have assuredly yelled at the book by now, of course I can determine from context what we are talking about. But this is exactly the point of this next section, that before starting a discussion you must set your context. What we will call our universe of discourse .   set The univese of discourse is our first example of a set .  So that we handle this playground with the respect it deserves, we will only give a very brief introduction to the topic right now, just what we need. We will dive deeper into set theory and use it as one of our major examples later on in the book!  Let's start with the very basics and define some things.   set  element   Set : A collection of stuff (or nothing).  Element : The stuff in the set.    The elements in a set do not have a particular order, so you can think of a set like a \"magical bag\" that holds things.  Set theory, like everything, comes with its own special notation. We often denote sets with a capital letter, and elements with a lower case letter.  The symbol can be read as \"in\" or \"is an element of\" or \"is a member of\"  For example, \" \" would be read as \" is in ,\" or, \" is an element of the set \", or \" is a member of the set \"  Besides just arbitrarly naming a set in attempts to define a set we can also describe what is the set by capturing all the elements in the set between the symbols and then listing the elements seperated by commas. For example is we just wanted to collect the following numbers in a set: Or if we were to collect the set of all counting numbers we could use ... to indicate continuing a pattern: We could also use what is known as set builder notation:     Common Universes  Throughout the text we will use a lot of common universes in our text, but also to really drive home the wide application of these theories we will use some less common universes as well. The most common universes we will deal with is the numbers, by which we will mostly discuss the following:    natural numbers  integers  counting numbers  rational numbers  real numbers  complex numbers      The Natural Numbers       The Integers       The Counting Numbers       The Rational Numbers       The Real Numbers       The Complex Numbers     Notice that I take the extremely divisive standpoint that contains 0. Later in the book we will justify this, but now, I am your teacher and thus you are in my camp on this issue!    Truth Sets and Predicate Forms  When we are discussing a general universe of discuourse we will denote it as . We will also often need to speak of a predicate in general terms so we will use the function notation for predicates. Such as for the predicate we can denote it by . And thus we can now determine that a statment like which is is false.   truth set  predicate After setting our universe can now talk about the truth set of a predicate , that is collecting all of the elements of our universe that make true.   truth set  The truth set for the open sentence \" \" depends on the universe of discord. When the universe is set as then the truth set is . When the universe is then the truth set is . If the universe was to be then the truth set would be the open interval .    Equivalent Predicates  predicate equivalent  equivalent predicate   For a fixed universe of discord, we say that two predicates, and , are equivalent iff they have the same truth set.  We will denote this as     Now lets see an example of this in play wiht some, perhaps, unexpected results.   predicate equivalent  equivalent predicate  The predicates and are equivalent in the universe . They are not equivalent in the universe .   This next example should work the way you expected.   The open statements and are equivalent in the universe but they again are not equivalent in the universe      The Existential Quantifier  Consider the predicate is, again, not a proposition as it depends on the universe and which from this universe we are talking about. But, there is a way of not choosing an from the universe to turn this into a proposition, that is to consider the statement: This proposition is still treated differently than other propositions we have considered, as it still depends on the universe. This new proposition can be formed from the predicate by applying a quanifier, that is we qualify our open sentence before saying it.   Existential Qunatifier  existential quantifier  exists  quantifier existential   For a predicate , the sentence is read or or The proposition is true iff the truth set of is nonempty. The symbol is called the existential quantifier     One way to show that is true for a specific universe is to identitify an object such that is true.   existential quantifier  exists  quantifier existential  For this example lets consider the following predicates                   For (C) the statement is true in the universe is true as as well as many other numbers. In statement (A) there are no real numbers that have any opinions on books for my understanding, but if the universe was all people then is true as I am a person and I love books. Similiarly for (B) the proposition, in the universe of all people is also true, as I also eat pizza!   In English there are many ways to say the existential quantifier, such as:    \"some\"    \"at least one\"    \"there is\"    and so many more.  I'd like to end this subsection with the symbolization of a statement which should be     The Universal Quantifier  The statement \"everyone reads books\" is being qualified by something different than an exists, yet does have a truth value and hence is a proposition. It is this quantifier that we call the universal quantifier.   Universal Quantifier  universal quantifier  quantifier universal  for all   For a predicate , the statement is read and is true iff the truth set of is the entire universe. The symbol is called the universal quantifier .    In English there are many ways to say the universal quantifier, such as:    \"for all\"    \"for every\"    \"for each\"    and so many more.    For this example lets consider the following predicates                   In (C) for the universe the proposition is false as yet 2 is not greater than 4. For (A) in the universe of all people, the proposition is also false as I have met many students whom dislike most math textbooks. Similiarly for (B) in the universe of all people the proposition is also false as I have met a health conscious person who does not eat pizza.   universal quantifier  quantifier universal  for all  There are many many many examples of the use of the universal quantifier, but one popular one that I'd like to take a moment to discuss is: this can be symbolized by     Negating Quantifiers  It is also important to note what the negation of each of these quantifiers are.   quantifier negation  negating quantifiers  exists negation  read literally says, \"There does not exist.\" Sometimes it is helpful to read this as \"everybody doesn't.\" That is    quantifier negation  negating quantifiers  for all negation  says \"not all,\" which can be thought of as, \"somebody does.\" That is     quantifier negation  negating quantifiers  for all negation  exists negation  For these examples we will see multiple ways to write them.          *NOT*(For all integers , is an integer)  For some integers , is not an integer.           *NOT*(There exists an integer such that  For all integers , does not equal .        Unique Existence  There is a special case of the existential quantifier, that is used when you want to be very clear that there is only one special member of the universe that satisfies your predicate.   Unique Existential Quantifier  unique existential quantifier  quantifier unique existential  exists unique   For a predicate , the proposition is read and is true iff the truth set of has exactly one element form the universe. The symbol is called the unique existential quantifier .    The difference between the existential and unique existential quantifier is the number of elements of the universe that sastify your open statement.    unique existential quantifier  quantifier unique existential  exists unique  Consider the next two predicates:                   The statement is true in the universe as the only number satisfying the statement , that is is even and prime, is The proposition on the other hand, is true for the universe , as the only natural number to satisfy this propostion is 2, but not true for the universe as there are two numbers, namely +2 and -2 in the integers which make the predicate true.     More Examples  Now we will give some more examples:      For every Indiana resident is older than 18, can vote     Some functions defined at 0 are not differentiable at zero     Some students are math majors and some students are buisnesss majors       "
},
{
  "id": "sec-2-1-2-1",
  "level": "2",
...
},
{
  ...
  "number": "1.5.1",
  "title": "",
  "body": " truth set  The truth set for the open sentence \" \" depends on the universe of discord. When the universe is set as then the truth set is . When the universe is then the truth set is . If the universe was to be then the truth set would be the open interval .  "
},
{
  ...
  "body": " Equivalent Predicates  predicate equivalent  equivalent predicate   For a fixed universe of discord, we say that two predicates, and , are equivalent iff they have the same truth set.  We will denote this as    "
},
{
  ...
  "number": "1.5.3",
  "title": "",
  "body": " predicate equivalent  equivalent predicate  The predicates and are equivalent in the universe . They are not equivalent in the universe .  "
},
{
  ...
  "number": "1.5.4",
  "title": "",
  "body": " The open statements and are equivalent in the universe but they again are not equivalent in the universe   "
},
{
  "id": "def-exists",
  "level": "2",
  ...
  "type": "Definition",
  "number": "1.5.1",
  "title": "Existential Qunatifier.",
  "body": " Existential Qunatifier  existential quantifier  exists  quantifier existential   For a predicate , the sentence is read or or The proposition is true iff the truth set of is nonempty. The symbol is called the existential quantifier    "
},
{
...
},
{
  ...
  "number": "1.5.2",
  "title": "",
  "body": " For this example lets consider the following predicates                   In (C) for the universe the proposition is false as yet 2 is not greater than 4. For (A) in the universe of all people, the proposition is also false as I have met many students whom dislike most math textbooks. Similiarly for (B) in the universe of all people the proposition is also false as I have met a health conscious person who does not eat pizza.  "
},
{
  "id": "subsec-2-5-6-neg-quant-6",
  "level": "2",
  "url": "sec-2-1.html#subsec-2-5-6-neg-quant-6",
  "type": "Example",
  "number": "1.5.1",
  "title": "",
...
},
{
  ...
  "number": "1.5.1",
  "title": "",
  "body": "   For every Indiana resident is older than 18, can vote     Some functions defined at 0 are not differentiable at zero     Some students are math majors and some students are buisnesss majors     "
},
{
  "id": "sec-1-4",
  "level": "1",
...
},
{
  ...
  "number": "2.1.4",
  "title": "",
  "body": " valid  argument valid  argument invalid  argument  Here are some example of valid arguments:    All parabolas are functions of degree 2    All functions of degree 2 are quadratic    All parabolas are quadratic      An apple is purple    An apple is a fruit    An apple is purple      All spiders have 8 legs    A poodle is a spider    A poodle has 8 legs    Here is an example of an invalid argument:    All chickens are animals that eat corn    All chickens are animals that have wings    All animals that eat corn have wings    "
},
{
  ...
  "body": " Arguments with Propositional Forms  In this section we will \"pull open the hood\" a bit, and explore the inner workings of the arguments with general propostional forms.  We begin with perhaps the most famous arguments. These are surely not the only tools we will use, but definitely some of the more important ones.   Modus Ponens  modus ponens  argument modus ponens   Modus Ponens is a specific type of argument with two premises: , and , and conludes . That is             An example of this is \"If it is raining then the ground is wet. It is raining. Therefore the ground is wet.\"    Modus Tollens  modus tollens  argument modus tollens   Modus Tollens is simply the application of the contrapositive, specifically: , and , and conludes . That is             A similiar example of this is \"If it is raining then the ground is wet. The ground is not wet. Therefore the ground it is not raining.\"   Eventhough these happen to be the most famous they are far from the only. Here is a not so complete list:   argument modus ponens  argument modus tollens  argument addition  argument simplification  argument Hypothetical Syllogism  argument simplification  argument Hypothetical Syllogism  argument Disjunctive Syllogism  modus ponens  modus tollens  addition  simplification  Hypothetical Syllogism  Disjunctive Syllogism    Argument:  Name:              Addition                    Simplification                       Conjunction                       Modus Ponens                       Modus Tollens                       Hypothetical Syllogism                       Disjunctive Syllogism     Now lets see some examples of these in play.  Now that we have our arguments written using propositional forms we can verify that each of these arguments are valid using a truth table, that is seeing they are all tautologies, or that they are always true.  We will do Hypothetical Syllogism and leave the rest as an exercise to the reader.   hypothetical syllogism truth table  argument hypothetical syllogism             T  T  T  T  T  T  T    T  T  F  T  F  F  T    T  F  T  F  T  T  T    T  F  F  F  T  F  T    F  T  T  T  T  T  T    F  T  F  T  F  T  T    F  F  T  T  T  T  T    F  F  F  T  T  T  T       argument  For this example lets set a few propositons:       Next consider the list of premises.                        When can then make the following arguments:   To start we will only consider the first premise.            Since we have assumed that it is not sunny and colder than yesterday we can conclude it is not sunny outside, using conjunction.    Now Let's use the conclusion from (A), with the next premise.               That is if we assume that it is not sunny and that we will go hiking only if it is sunny, then we can conclude that we do not go hiking, using Modus Tollens.    Now using the conclusion from (B) and our next premsise we see               Since we have assumed that we are not hiking and that if we don't hike then we will go on a bike ride we can thus conclude that we will go on a bike ride by Modus Ponens.    Now using the conclusion of (C) and our next premise.               Hence since we assumed that we are going on a bike ride and if we go on a bike ride we will be back home by dark we can conclude that we will be back by dark again by Modus Ponens.     We have just done our first proof, and shown if all the statements are assumed then we can conclude that we will be home before dark!   "
},
{
...
},
{
  ...
  "number": "2.2.3",
  "title": "",
  "body": " argument  For this example lets set a few propositons:       Next consider the list of premises.                        When can then make the following arguments:   To start we will only consider the first premise.            Since we have assumed that it is not sunny and colder than yesterday we can conclude it is not sunny outside, using conjunction.    Now Let's use the conclusion from (A), with the next premise.               That is if we assume that it is not sunny and that we will go hiking only if it is sunny, then we can conclude that we do not go hiking, using Modus Tollens.    Now using the conclusion from (B) and our next premsise we see               Since we have assumed that we are not hiking and that if we don't hike then we will go on a bike ride we can thus conclude that we will go on a bike ride by Modus Ponens.    Now using the conclusion of (C) and our next premise.               Hence since we assumed that we are going on a bike ride and if we go on a bike ride we will be back home by dark we can conclude that we will be back by dark again by Modus Ponens.     We have just done our first proof, and shown if all the statements are assumed then we can conclude that we will be home before dark!  "
},
{
  "id": "sec-3-3-fallacy",
  "level": "1",
  ...
  "body": " The Bad and the Ugly  There are many ways to make a valid argument, and many ways to make an invalid argument. As a student of proofs it is inevitable that you will make all of the mistakes, and find new and amazing ways of making invalid arguments, it is unavoidable. But, don't fret, that is the beautiful learning journey you are on!  A very common mistake that students will make when arguing is what is known as circular reasoning .   Catch 22  fallacy Catch 22  fallacy circular reasoning  fallacy begging the the question  Catch 22  circular reasoning  begging the the question   Circular reasoning or begging the question or catch 22 happens when we assume the statement we are trying to conclude.    The term Catch 22 was coined by the character Doc Daneeka, an army psychiatrist, in the novel Catch 22 , to describe a governmental loophole that prevented pilots from requesting a mental evaluation to avoid dangerous missions.   This fallacy comes from the very valid argument:            It's just this argument doesn't get you very far.  Consider the next example of circluar reasoning.   Say I was trying to conclude that a number is even, then circular reasoning would be: \"Assume that is even, thus is even\"   Another mis-step that stuents are bound to take is almost a mis-application of the contrapositive, or thinking the implication is stronger than it is.   Denying the Antecedent  denying the antecedent  fallacy denying the antecedent   Denying the antecedent is the invalid argument                Recall that the contraposition is but not .   Consider the statment: \"If it is sunny then we will go on a bike ride\". then we still might go on a bike ride if it's not sunny, I was just saying if it's sunny we will definitely go!   Another mistake in a similiar fashion again mistaking the power of the implication.   Affirming the Conclusion  affirming the conclusion  fallacy affirming the conclusion   Affirming the conclusion is the invalid argument                Recall that is NOT the same as .   Consider the statment: \"If it is sunny then we will go on a bike ride\". then just because go on a bike ride doesn't some how make it sunny, again I was just saying if it's sunny we will definitely go!   "
},
{
...
},
{
  ...
  "number": "2.3.1",
  "title": "",
  "body": " Say I was trying to conclude that a number is even, then circular reasoning would be: \"Assume that is even, thus is even\"  "
},
{
...
},
{
  ...
  "number": "2.3.2",
  "title": "",
  "body": " Consider the statment: \"If it is sunny then we will go on a bike ride\". then we still might go on a bike ride if it's not sunny, I was just saying if it's sunny we will definitely go!  "
},
{
...
},
{
  ...
  "number": "2.3.3",
  "title": "",
  "body": " Consider the statment: \"If it is sunny then we will go on a bike ride\". then just because go on a bike ride doesn't some how make it sunny, again I was just saying if it's sunny we will definitely go!  "
},
{
  ...
  "body": " Arguments with Quantifiers  We have seen in that quantified statments can lead to interesting arguments. For example    All are     All are        For example \"All longshoremen are in a union\" and \"All unions have dues\" thus we can conclude that \"All longshorement pay dues\".  Next we have a far from complete list:   argument Universal Instantiation  argument Universal Generalization  argument Existential Instantiation  argument Existential Generalization   Argument:  Name:                  Universal Instantiation                  Universal Generalization                  Existential Instantiation                  Existential Generalization    These will be instrumental to our proofs invovling quantifiers shortly! And since we will attempt to put them in more plain language...    The How-To's with Assuming quantifiers:     Assuming  Can do  Name     It always works so use it for one that you already have  Universal Instantiation     Can produce an element it works for and then you can use it  Existential Instantiation     The How-To's with Concluding quantifiers:     Want to Conclude  Must do  Name     choose an arbitrary one and then show it works for that one  Universal Generalization     GIVE an element and then show it works for that one  Existential Generalization     "
},
{
...
},
{
  ...
  "number": "3.1.4",
  "title": "",
  "body": "  Defintions are ASSUMPTION\/PREMISES , so when using arguments from the previous chapter use them as such.  "
},
{
  ...
  "number": "3.2",
  "title": "Direct Proof",
  "body": " Direct Proof  Our first method before proving is known as direct proof, it is the student's go-to throughtout their career.  Most often we will proving statement that look like:   So, before we dive into it I'd like to give the song that we will sing whenever we start proving.    What's the P? (The \"if\" part)  What's the Q? (The \"then\" part)  What're the definitions?  Now, what to do? (Which proving method - until we learn more this will always be direct proof)     What is a Direct Proof?  Now without further ado the direct proof.   Direct Proof of  direct proof steps  Assume      Therefore   Thus    Here is where the title of the text becomes clear:   -- Assume    -- ...   -- Therefore     Does it Work?  We have an entire chapter about arguments, so does this direct proof work?  Is the direct proof a valid argument?   direct proof valid              To see this the \"long way\" lets build a truth table:            T  T  T  T  T    T  F  F  F  T    F  T  F  T  T    F  F  F  T  T     And we see that is a tautology! I.e. the direct proof is a valid argument!   Yes, your eyes do not decieve you, I did just prove that the direct proof is a proof.    "
},
{
  ...
  "number": "3.2.1",
  "title": "",
  "body": " Yes, your eyes do not decieve you, I did just prove that the direct proof is a proof.  "
},
{
  ...
  "body": " Our First Proof  Now that we have our first weapon in hand (the direct proof) lets start to slay our first dragon.    Prove: For all integers , whenever is odd then is even.  Before we begin any proof we sing our song (play-along):  \"What's the ?\"   is odd   \"What's the ?\"   is even   \"What're the definitions?\"   Odd ( ) and even ( )!   \"Now, what to do?\"   A direct proof! (it is the only method we know so far)      One purpose of our fun song is for us to to split what we want to prove into the and the .  Once we have it split like that we see something left over... this is the . This quantifier is quite often forgotten\/assumed when it is not written but assumed there we call it the hidden quantifier . Either way the statement we are trying to prove is now broken up as follows:   To prove our statment with this , according to Universal Generalization from we need to show it works with an arbitrary integer.  To indicate this in our proof we may begin with either of the senctences:  \"Let be an integer.\"  or  \"Choose an arbitrary integer \"   Now, we can take care of the from the direct proof:  Assume the \" \"  \" .\"      To proceed with our proof we don't have much expcept the definitions. (It can be helpful, especially in these early stages of proof writing, to write the relevant definitions to the side in your scratch work - this is why it's part of the song!)  From the definition odd ( ) we can make the conclusion that:  must look like: for some integer .  Invoking this definition in this manner is an application of Existential Instantiation from    To continue muddling along we can use some college algebra, as is allowed by and calculate:   The on the left of this equation is the end conclusion we're aiming for! ( \"What's the \" from the song)  The stuff on the right is what we manipulate to make it \"look like,\" or \"fit,\" the definition of even. We will attempt to make this more clear in the next subsection.   I choose these as the first types of proofs to show\/have students do first, because the is bascially the same for all of them: \"invoke a defintion then calculate\". It gives the students something to hold on to as they are still trying to digest the previous chapters...      From the , we have:   To be able to make our conclusion we must use defintion of even ( ), which uses an existential quantifier so we must ( ) be able to produce\/point at an integer, so that is this integer times 2.  We have exactly that, because ( ) is an integer!  To write this in our proof we can say:  \"Since is an integer, by definition of even, is even.\"  Finally we should end every proof with a wrap-up sentence. This sentence is to summarize the proof, most importantly laying out your proving method, in this example a direct proof.  For this proof our wrap-up could look like:  \"Since we assumed that an arbitrary integer was odd and showed that is even, we can conclude that for all integers , whenever is odd then is even, by direct proof.\"  At last we indicate that our proofs are over with a:    To wrap-up everything in a pretty bow, lets see the whole proof in one spot.   When a proof is finished, customarily, we either write \"QED\" or at the bottom. This comes from the Latin \"quod erat demonstrandum,\" which means \"that which was to be demonstrated.\"     Prove: For all integers , whenever is odd then is even.   Let be an integer. Assume is odd. Thus, by the definition of odd, we can find an integer so that .  Calculate:   Since is an integer, by definition of even, is even.  Since we assumed that and arbitrary integer was odd and showed that is even, we can conclude that for all integers , whenever is odd then is even, by direct proof.     "
},
{
  ...
  "number": "3.3.1",
  "title": "",
  "body": " I choose these as the first types of proofs to show\/have students do first, because the is bascially the same for all of them: \"invoke a defintion then calculate\". It gives the students something to hold on to as they are still trying to digest the previous chapters...  "
},
{
  "id": "sec-4-3-3-end-14",
  "level": "2",
  ...
  "number": "3.3.1",
  "title": "",
  "body": "  Prove: For all integers , whenever is odd then is even.   Let be an integer. Assume is odd. Thus, by the definition of odd, we can find an integer so that .  Calculate:   Since is an integer, by definition of even, is even.  Since we assumed that and arbitrary integer was odd and showed that is even, we can conclude that for all integers , whenever is odd then is even, by direct proof.   "
},
{
  ...
  "body": " More Direct Proof Examples  We will give each of these examples a subsection, then further sub-divde the sections for their indepth explanations.    Direct Proof Example 2  Prove: For all integers and , if and are both odd then is even.   Before we begin any proof we sing our song (play-along):  \"What's the ?\"   and are both odd   \"What's the ?\"   is even   \"What're the definitions?\"   Odd( ) and even ( )!   \"Now, what to do?\"   A direct proof! (it is the only method we know so far)    The Breakdown:        Just as before we begin by \"shoveling off\" our ( ) by saying something along the lines of:  \"Choose arbitrary integers and .\"   Now, we take care of the of our direct proof...   Assume the    So in our example we would write:  \"Assume both and are odd.\"     Again, as will be quite often even after this class, we do not have much but the definitions ( ), so we will apply these defintions (making note they invovle quantifiers ).  To apply the definition of odd ( ) to our integer we use the exists from the proof to produce a new integer which will need a name, lets name it . This can be found so that .  Some questions that often arise here are: \"but the proof says ?\" Yet, in fear of sounding like a broken record we are using\/applying the definition of odd, and when using the (by ) we can find some integer (in this example) to do the job. The in the definition is just a stand-in for some integer .  So for our proof we could write:  \"By the definiton of odd we can find an integer so that .\"  Next, we do the exact same procedure with the , but because is a new number and it is a brand new application of the definition of odd we can produce a a new integer ( ), so this time lets name it .  That is in our proof we could write:  \"Again, By definition of odd, we can find an integer such that .\"  Having successfully applied our definitions we now have something we can calculate with, so lets try to add what is in our namely    Now, we can (hopefully) see our definition of even at the last equality, signalling that we are ready for our .     From the , we have:   To be able to make our conclusion we must, again, use defintion of even ( ), which uses an existential quantifier so we must ( ) , be able to produce\/point at an integer, so that is this integer times 2.  We have exactly that, because ( ) is an integer!  To write this in our proof we can say:  \"Since is an integer, by definition of even, is even.\"  Finally we should end every proof with a wrap-up sentence. This sentence is to summarize the proof, most importantly laying out your proving method, in this example a direct proof.  For this proof our wrap-up could look like:  \"Since we assumed that an arbitrary two integers and were odd and showed that is even, we can conclude that for all integers and , whenever and are odd then is even, by direct proof.\"  Now lets see everything written together in a single spot.   1  Prove: For all integers and , if and are both odd then is even  Choose arbitrary integers and . Assume both and are odd. By the definiton of odd we can find an integer so that . Again, By definition of odd, we can find an integer such that .  Now calculate:   Since is an integer, by definition of even, is even.  Since we assumed that an arbitrary two integers and were odd and showed that is even, we can conclude that for all integers and , whenever and are odd then is even, by direct proof.      Direct Proof Example 3  The last two examples had even in the and even in the . In fear of students thinking this is some sort of immutable law\/pattern lets change that pattern this time.   Prove: For all integers and if and are both odd then is odd.   Before we begin any proof we sing our song (play-along):  \"What's the ?\"   and are both odd   \"What's the ?\"   is odd   \"What're the definitions?\"   Odd ( )!   \"Now, what to do?\"   A direct proof! (it is the only method we know so far)    The Breakdown:        We begin by taking care of our leading quantifier, , trying our best to never forget . To do this we could use a variety of english statments to do this, for example:   \"Select two random integers and \"    \"Choose two arbitrary integers and \"    \"Let and be integers\"     Next, we do the of a direct proof, that is . From our song we already know this, and that is:  \"Assume and are both odd\"     Now, as we see in this first class of proofs so often, the only tools we really have at our disposal are the definitions from . In this proof we have to apply a definition twice from our previous line\/assumption namely:     is odd     is odd    Something that bares repeating over and over and over and over again, is to always remember . Right now we need to remember this because the definition of ( ) invoke an existential quantifier. So to apply the definition of odd for we can use language like:  \"We can find an so that .\"  To use the definition of odd for our we can use language like:  \"We can also find a so that .\"  Now that we have used our defintions we can move to our usual where we use some good ole college algebra . In a more general look at proofs at a whole is that you should keep in mind what we are trying to conclude, i.e. the , namely that . So we should calculate .  Calculate:      From the we know have: Now, using the definition of odd ( ) and of course we can conclude that from the that is odd, as is an integer and thus is an integer, and hence we have that is an integer times 2 then plus one.  Now lets see everything written together in a single spot, with a proper wrap-up.   2   Prove: For all integers and if and are both odd then is odd.  Select two random integers and . Assume that is even and is odd. By defintion of even we can find an integer so that . Also, by the definition of odd we can find an integer so that . Now we calculate:   Now since is an integer, we see that is odd.  To summarize, since we chose arbitrary integers and which we assumed were even and odd, respectively. By direct proof we proved that for all integers and , if is even and is odd, then is odd.       Direct Proof Example 4  Now lets see an example that is not even nor odd.  Prove:  if and then   Before we begin any proof we sing our song (play-along):  \"What's the ?\"   and   \"What's the ?\"     \"What're the definitions?\"   divides ( )   \"Now, what to do?\"   A direct proof! (it is the only method we know so far)    The Breakdown:        This proof is the same as we have been doing at the beginning as it starts with our . As usual we take care of that using:  \"Let and be integers.\"  As we are still doing a direct proof our first step invovling this is , and for this example it is:  \"Assume that both and .\"     In this example we go to our definitions again (being careful for the quantifier ), specifically for we use the definition of divides ( ) as follows:  \"By definition of divides we can find an so that .\"  For we apply the definition of divides ( ) as:  \"By definition of divides we can find a so that .\"  Something I have seen students do here is write \"exists an integer \". You are using the existential quantifier to produce a specific integer ( ), by saying exists you are just telling me that you could theoretically find one, not telling that you a producing one to use.  So now that we have something we can use, like usual we can calculate:      From we have and then we can reference a couple of our assumptions from , and say:  \"Since is an integer and thus is an integer by the definiton of divides 5 divides .\"  Now lets see everything written together in a single spot, with an appropriate wrap-up.   3  Prove:  if and then  Let and be integers. Assume that 5 divides both and . Next, we calculate:   Since is an integer it follows that is an integer thus by the definiton of divides, 5 divides .  To summarize since we chose arbitrary integers and and assume that 5 divides both of them and have shown that hence by direct proof we have shown that for any integers and if and then       Direct Proof Example 5  For our last detailed example of a direct proof it is a classic inequality. Inequalities will a large role in your future analysis class.  Prove: For all positive real numbers and , if then .   Before we begin any proof we sing our song (play-along):  \"What's the ?\"     \"What's the ?\"     \"What're the definitions?\"   is positive mean   \"Now, what to do?\"   A direct proof! (it is the only method we know so far)    The Breakdown:        This beginning is the same as the others we take of the by:  \"Let and be positive real numbers.\"  For our approach of a direct proof we need to start by , that is:  \"Assume that \"     Now as is in most inequality proofs first we need to work backwards first that is notice: by our allowed assumptions of basic college algebra . But we have that since both and , then again with our assumptions of college algebra that we can, lets say, add to the left side of and add 0 to the right side. Also, as since subtracting from both sides of our assumption .     To write our proof in a logical format we will have to go the opposite direction, as otherwise we will have said our conclusion before we concluded it, essentially falling for circular reasoning, that is:  Since subtracting from both sides of our assumption we see that , and by adding to the left and 0 to the right of we get that . Finally, since we can multiply both side of by it and arrive at:   Now lets see everything written together in a single spot.   4  Prove: For all positive real numbers and , if then .  Let and be positive real numbers. Assume that .  Since subtracting from both sides of our assumption we see that , and by adding to the left and 0 to the right of we get that . Finally, since we can multiply both side of by it and arrive at:   Since we assumed and are positive real numbers and , then we showed that by direct proof we can conclude, that for all positive real numbers and if then .     "
},
{
  ...
  "number": "3.4.1",
  "title": "1.",
  "body": " 1  Prove: For all integers and , if and are both odd then is even  Choose arbitrary integers and . Assume both and are odd. By the definiton of odd we can find an integer so that . Again, By definition of odd, we can find an integer such that .  Now calculate:   Since is an integer, by definition of even, is even.  Since we assumed that an arbitrary two integers and were odd and showed that is even, we can conclude that for all integers and , whenever and are odd then is even, by direct proof.  "
},
{
  ...
  "number": "3.4.1",
  "title": "2.",
  "body": " 2   Prove: For all integers and if and are both odd then is odd.  Select two random integers and . Assume that is even and is odd. By defintion of even we can find an integer so that . Also, by the definition of odd we can find an integer so that . Now we calculate:   Now since is an integer, we see that is odd.  To summarize, since we chose arbitrary integers and which we assumed were even and odd, respectively. By direct proof we proved that for all integers and , if is even and is odd, then is odd.   "
},
{
...
},
{
  ...
  "number": "3.4.1",
  "title": "4.",
  "body": " 4  Prove: For all positive real numbers and , if then .  Let and be positive real numbers. Assume that .  Since subtracting from both sides of our assumption we see that , and by adding to the left and 0 to the right of we get that . Finally, since we can multiply both side of by it and arrive at:   Since we assumed and are positive real numbers and , then we showed that by direct proof we can conclude, that for all positive real numbers and if then .  "
},
{
  ...
  "body": " Proofs with Conjunctions and Disjunctions  So far we have been proving the prototypical as it is perhaps one of the most common propositional forms used in mathematics, and otherwise. Yet, in all of our examples thus far both and have been atomic propositions. In this section we will be substuting the antecedent and consequent with compound propostions.   Assuming an Or  disjuntion proofs with assuming or  or proofs with assuming or  For propostions , , and , to prove a statment in the form of   First we:   Prove:    then we:   Prove:     To verify that this argument is valid, we will use a truth table to show: is a tautology. To do so we will show a stronger result using the tricks of .   Now lets see an example of this in play.    Prove: for any two integers and if is even or is even then is even.   Let and be integers.  First assume that is even. By definiton of even ( ) we can find an integer so that . Calculate: since is an integer by the definition of even, is even.  Next, we instead assume is even. By defintion of even we can find an integer so that . Calculate: since is an integer by the defintion of even, is even.  Now since we have shown that for that both is even implies is even and is even implies is even, we have thus shown that .    Another interesting scenerio is when we are trying to conclude a disjunction.   Concluding an Or  disjunction concluding or  or concluding or  For propostions , , and , to prove a statment in the form of   We instead   Prove:     That this argument is valid can be seen by showing that To do that we will again use the tricks of .     Now lets see an example.    Prove: For all integers and if is even then is odd or is even   Let and be arbitrary integers. Assume that is even and that is not odd. By the definition of even ( ) we can find an integer so that . By the division algorithm ( ) we can find integers and such that such that . Yet since we assumed is not odd , and since is an integer and and the only integers which satisfy this inequality are 0 and 1, which only leaves thus . Now calculate: Since is an integer by the definition of even is even.  Since we have assumed for two arbitrary integers and that is even and is not odd and we have concluded that is even we can conclude For all integers and if is even then is odd or is even.    The last propositional form we consider in this section is the following.   Concluding an And  conjunction concluding an and  and concluding an and  For propostions , , and , one way to prove a statment in the form of   First we:   Prove:    then we:   Prove:     To see that this is a valid way of proving, we once again show an even stronger result using the methods of .       Prove: For all integers and , if and then and    Let and be arbitrary integers.  Assume that , also assume that . By defintion of divides ( ) we can produce an integer such that , and hence by adding 2 to both sides of this equation we get . As well by the definition of divides we can come forth with another integer with the property that , this time adding 1 to both sides of the equation we see that .  Now, we will prove: if and then , by calculating: and since is an integer by the definition of divides .  Next, we will prove: if and then , instead by calulating: and since is an integer by the definition of divides .  Now that we have assumed that and are arbitrary integers and assumed that and then we showed that both and that we can conclude that for all integers and , if and then and .    "
},
{
...
},
{
  ...
  "number": "3.5.3",
  "title": "",
  "body": "  Prove: For all integers and , if and then and    Let and be arbitrary integers.  Assume that , also assume that . By defintion of divides ( ) we can produce an integer such that , and hence by adding 2 to both sides of this equation we get . As well by the definition of divides we can come forth with another integer with the property that , this time adding 1 to both sides of the equation we see that .  Now, we will prove: if and then , by calculating: and since is an integer by the definition of divides .  Next, we will prove: if and then , instead by calulating: and since is an integer by the definition of divides .  Now that we have assumed that and are arbitrary integers and assumed that and then we showed that both and that we can conclude that for all integers and , if and then and .   "
},
{
...
},
{
  ...
  "number": "3.7",
  "title": "Exercises",
  "body": " Exercises  Direct proofs with just even and odd   prove the following.   if is even, then is even  if and are odd, then is odd  if is even, and and are odd, then is odd   if and are even then is divisible by 4.    if and are odd then is even.    if and are even then is even.    if is odd then is odd    if then     if and then     if is odd then is even      , prove the following with techniques from     If and then and .    If then 7 does not divide or .    If is even or then .      Suppose that you would use a direct proof if you were to prove the following statements. For each only write \" \" and \" \"    For every real valued function , if is differentiable then is continuous.    For all slompins, , if is an insteredment then is flooxin.    If is an annsubmir and is a curric-fac then is a divisper.    For every two integers and , if is threeven and is thud, then is thodd.      Direct proofs with divides and proof by cases   If and are even, then  is odd (Proof by cases)  is odd (Proof by cases)  If and then  If then   Contradiction, Contraposition, Bi-conditional   If then is odd. (Contraposition)  If is odd then x and are odd. (Proof by cases)  If then (Contraposition)  If is odd then and are odd. (Contradiction)  If is odd, then is odd. (Contradiction)  is irrational. (Contradiction)  if and only if . (bi-conditional)   "
},
{
  ...
  "body": " Our Assumptions  In this chapter you can assume anything you had in . We also include a few more defintitons for this chapter.     Common Divisor  common divisor    , all non-zero, we call a common divisor of and iff divides and divides .       Greatest Common Divisor  greatest common divisor    , all non-zero, we call the greatest common divisor of and , denoted iff    is a common divisor of and     every common divisor of of and has the property . (every other divisor is smaller)          Rational  rational number            1-d Integer Cone  1-d integer cone   For any integers , , ..., for some natural number we say an integer is in the 1-d integer cone formed by  , , ..., if and only if there exists integers , , ..., so that      "
},
{
...
},
{
  ...
  "body": " Contrapositive   This first example of an indirect proof, is quite close to the indirect proof. It takes some of our ingenuity from and puts it to work.     What is a Proof by Contraposition?  A proof by contraposition uses (of course) the contraposition from    So that we can prove by instead proving . To prove this equivalent statment we will use direct proof. We summarize this in the following.   Proof by Contrapositive of  contrapositive proofs invovling  proof by contrapositive  Assume      Therefore   Thus    Again, the title of the text becomes clear:   -- Assume    -- ...   -- Therefore     First Example of Contrapositive  For our first example, just as in , we will give as many gory details as we can think of to help the eager student of proofs.  Prove:  if is odd, then is odd.  Before we begin any proof we sing our song (play-along):  \"What's the ?\"   is odd  But... for this question we need to really know the :   is not odd odd   \"What's the ?\"   is odd  But... again... for this question we need to really know the :   is not odd odd   \"What're the definitions?\"   Odd and even! (found in )   \"Now, what to do?\"   Proof by contraposition - because we are trying to learn it   The Breakdown of the orginal:      The Breakdown of the contrapositive:        When first getting used to the contrapositive students have at times made the mistake of negating the which in this case would be . Be careful as the statment actually has the form  where        Just like before, \"shovel off\" the  using the guidance of by choosing an arbitrary element, with language like:     Let be an integer    Choose an arbitrary integer     Pick an integer     Take any integer of your choice    Let be a freely chosen integer    Assume is an integer, chosen arbitrarily    Designate an integer of arbitrary selection    Grab yerself any ol' integer, and let it be called !    Hark! Select an integer, and let it bear the name , chosen as thou wilt    Pick an integer, any integer, and call it . Doesn't matter which—it could be lurking anywhere, but is the one we'll follow    Aye, take , an integer, any integer, an of no particular choosing but of the choosing all the same—floating through the mind like a thought barely caught, yet caught still: it is.     Now we take care of our of our proof using this new method of proof by contrapostion, by assuming .  Assume is not odd.  Now, many of you may be reading this last line yelling with your fist in the air saying, \"who says not odd, just say even\". Yet, we must of course consult our allowed assumptions section ( ) and the assumption that \"not odd\" is equivalent to \"even\" is not one of those!     As the pain point of even vs odd is not lost to me and it will be helpful to be able to write proofs without having to prove that not odd is the same as even every single time. This want to not prove something over and over again, or to seperate a smaller proof from a different result comes up a lot, so when we want to do this we create a Lemma.   The word Lemma comes from the Ancient Greek λῆμμα, (perfect passive εἴλημμαι) something received or taken. Thus something taken for granted in an argument.     Let be an integer, then is either even or odd.     By the division algorithm ( ) we can find integers and such that such that . Yet since is an integer and and the only integers which satisfy this inequality are 0 and 1, we are left only with (even) or (odd).   With our assumption that is not odd and this Lemma in hand we could use Disjunctive Syllogism ( ) in our proof we could write:  Since we assumed that is not odd by we can conclude that is even.  Now we finally have in our proof that is even so we can go back to what we have come accustomed to: using the definitions. Specifically in this example we could write something like:  Thus by definition of even we can find an integer such that  Then, we could continue following our nose to do the common muddle so far in this text, and that is to calculate .  Calculate:      From the we have that from the definitoin of even ( ) we can now conclude:  Since is an integer, according to the definition of even, is even.  Now this is not exactly what we want to conclude. We want to conclude that: so again using Disjunctive Syllogism ( ) and our newest lemma we could write:  Because we have concluded that is even by we can now conclude that is not odd.  Finally, we can write our wrap up sentence!  Hence, by proof by contraposition if is odd then m is odd.  Now let's see everything written together in a single spot.   Prove: For any integer , if is odd, then is odd.  Let be an integer. Assume is not odd. Hence, by we can conclude that is even.  By definiton of even we can find an integer such that   Calculate:   Since is an integer, according to the definition of even, is even. Because we have concluded that is even by we can now conclude that is not odd.  Hence, by proof by contraposition if is odd then m is odd.     "
},
{
  "id": "sec-4-2-2-first-contrapositive-19-1",
  "level": "2",
  "url": "sec-4-2-contrapositive.html#sec-4-2-2-first-contrapositive-19-1",
  "type": "Note",
  "number": "4.2.1",
  "title": "",
  "body": " When first getting used to the contrapositive students have at times made the mistake of negating the which in this case would be . Be careful as the statment actually has the form  where   "
},
{
  "id": "lem-odd-not-even",
  "level": "2",
...
},
{
  ...
  "number": "4.2.1",
  "title": "",
  "body": " Prove: For any integer , if is odd, then is odd.  Let be an integer. Assume is not odd. Hence, by we can conclude that is even.  By definiton of even we can find an integer such that   Calculate:   Since is an integer, according to the definition of even, is even. Because we have concluded that is even by we can now conclude that is not odd.  Hence, by proof by contraposition if is odd then m is odd.  "
},
{
  ...
  "number": "4.3",
  "title": "Contradiction",
  "body": " Contradiction  Our next method for proving is known as proof by contradiction. It is an extremely powerful example of an indirect proof. It plays off the concept of the excluded middle, in more plain language a statement is either true of false and nothing inbetween.   The excluded middle is also known as the law \/ principle of the excluded third, in Latin principium tertii exclusi. Another Latin designation for this law is tertium non datur or \"no third [possibility] is given\".    What is a contradiction?  Proof by contradiction is the most different than the direct proof yet. The first big difference is that before now we have always considered the case where we were proving yet this time we will be only considering proving any proposition . This does not mean that we will not use it to prove propoositions in the form of an implication, because we definitely will, it is just that we set up the proof not seperating the implication as we have done before.   Proof by Contradiction of  contradiction  proof by contradiction  Assume      Therefore      Therefore   Hence which is a contradicition.  Thus   On first look it might also seem to not follow our title, but of course:   -- Assume    -- conclude ... conclude    -- Therefore is a contradiction  This proving method may also not seem to fit immediately into our argument section ( ). To see how it fits in first notice that before the conclusion this method is simply the direct proof of the statement Yet, this is equivalent to , to see that consider the following truth table.          T  T  F  T    T  F  F  T    F  T  F  F    F  F  F  F      Finally, before we move on, when we want to use contradiciton to prove a statment in the form of we will need to assume that . So it may be helpful to review how to negate such a statment, using our techniques from  and hence we have the equivalence:     First Example of Proof by Contradiction  For our first example of contradiction we will stick with our saftey blanket of the integers.  Prove: For all integers and if is odd then is odd.  Before we begin any proof we sing our song (play-along):  \"What's the ?\"   is odd   \"What's the ?\"   is odd   \"What're the definitions?\"   even ( ) and odd ( )   \"Now, what to do?\"   Proof by contradiction - so we can try and learn it!   The Breakdown:       To begin our proof we first take care of the . As is usual we will do this by choosing arbitrary integers, that is we will use language like:  Let and be arbitrary integers.   Again be careful even though we will be negating we DO NOT negate the quantifier!   Now to begin our proof by contrapositon we need to   But is not in our song! Yes that's true, but is just \"what we want to prove\". In this example we want to prove if is odd then is odd. So we will need to assume or using our analysis above we will:  Assume that is odd yet is not odd.  Now this is false, and it is our job to confirm that, yet a reader with no warning might be very alarmed that you began your proof with such a blatently false assumption. To quell our reader's troubled stomache, and let them know what we're doing, we can start the sentence with:  For the sake of contradiction...  Or for those more inclined to the classics we can simply at the beginning of our proof write:  [RAA]  which stands for reductio ad absurdum , that is, \"reduction to absurdity.\"     Next, almost right away we can react almost with knee jerk and play off our assumption with:  Since we assumed that is not odd, by we have that is even.  Now, again, as if we were to knee jerk we could then apply our definitions of even ( ) and odd ( ) with language similiar to:  By the definition of odd we can obtain an integer so that . As well, by the definition odd ( ) we are able to select an integer so that .  Yet, this is where our quick reactions or just using the defintions we have sung in our song end. In other examples we would look to the quintessential our target to set up a calculation. Unfortuantely in a proof by contradiciton we are in search of a brand new proposition (which we have lovinginly named ) further more we also need to find its negation ( ). This search is not always easy, and where to begin isn't always clear.  For this example we wondered in the woods and simply added the two things from our assumption together...  Calculate: and similiar to many proofs that came before this we can conclude that since is an integer by the definition of odd, we have that   But, there is of course another way of calculating this sum with no consideration of these newly found integers, and , that is... yet, since is an integer by the defintion of even we have that is even, or in light of we have: Therefore we have stumbled upon our contradiction, our  and not .     Now that we have found our contradiction of we should make sure to point out this contradiciton just incase our reader missed this, letting everyone know we have come to of our proof by contradiction. We, of course, can do this by following numerous linguistic paths but we must choose one so:  Yet, is an integer and cannot be both even and odd, which is a contradiction. Thus using proof by contradiction we have successufly shown that for all integers and if is odd then is odd.  As usual we collect it in our tldr boxes...   Prove: For all integers and if is odd then is odd.  Let and be arbitrary integers. For the sake of contradiction assume that is odd yet is not odd. Since we assumed that is not odd, by we have that is even. By the definition of odd we can obtain an integer so that . As well, by the definition odd ( ) we are able to select an integer so that . Calculate: since is an integer by the definition of odd, we have that is odd. Yet, we can also calculate as: yet, since is an integer by the defintion of even we have that is even, or in light of we have that is even.  Yet, is an integer and cannot be both even and odd, which is a contradiction. Thus using proof by contradiction we have successufly shown that for all integers and if is odd then is odd.      is Irrational  This next proof is a proof that I believe every single student in mathematics should now and love. It is this proof that I learned very early on in my math career that shaped how I understood mathematics. I would meet people and tell them \"I'm a math major\" and they would say things like \"ugh I always hated math\" and I would tell them no math is not what you think math is. It is about truths, for example take an extremely simple shape the right triangle, literally just put two sticks at a sharp angle and connect the two edges with another stick. This third stick has a length that is not a fraction of either of the other sides. Pythagoerous went to his grave believing that it must, but we can show beyond a shadow of a doubt it is not.  Before we jump into that proof it will be helpful to have a lemma that we can call on, in all honesty to shorten our work load (what lemma's are best for).    If 2 divides then 2 divides      Let be an integer. We will prove this using contraposition, that is we will assume 2 does not divide , thus by  is odd. Hence we can find an integer such that .  Calculate:   Since is an integer, by definition of odd, is odd, hence by  is not even. Thus by proof by contraposition, if 2 divides then 2 divides .   Prove:  is irrational.  Before we begin any proof we sing our song, although it is a little different when we're using contradiction (play-along):  \"What's the ?\"   is irrational   \"What's the ?\"   There is no this time!   \"What're the definitions?\"   Rational, relatively prime, and divides (create reference here!)   \"Now, what to do?\"   Proof by contradiction - because I said so!     For a proof by contradiction we need to begin by assuming what we need to prove is false, and to remind you this could be jarring to a reader so let them know what you are doing, for example we could write:  For the sake of contradicion assume that is rational. That is, it is not true that is irrational     Now, we continue with our song by applying the defintions we can, per the definition of rational ( ), we can find two integers and so that and Next, we will do exactly what any good calculus student would do and that is \"get-rid-of\" that square root.  Calculate:   But, is an integer, thus by the definition of even, is even. Hence, by we can conclude that is even  Thus, by the definition of even we can find an integer so that .  Now, we can play our common replacement game.  Calculate again:   But is an integer, so, by definition of even, is even, and again by , is even.  Since and , 2 is a common divisor, and thus by definition of greatest common divisor ( ) we have that , yet this means that     So now that we have found our contradiction we are done, but just incase the reader missed this contradiction as you unwrapped it, lets put it all in one place.  Thus we have shown  and  which is a contradiction. Thus by proof by contradiction, we have shown that is irrational.  Now let's see everything written together in a single spot.   Prove:  is irrational.  For the sake of contradicion assume that is rational. That is, it is not true that is irrational. By the definition of rational ( ), we can find two integers and so that and  Calculate:   But, is an integer, thus by the definition of even, is even. Hence, by we can conclude that is even  Thus, by the definition of even we can find an integer so that .  Calculate again:   But is an integer, so, by definition of even, is even, and again by , is even.  Since and , 2 is a common divisor, and thus by definition of greatest common divisor ( ) we have that , yet this means that  Thus we have shown  and  which is a contradiction. Thus by proof by contradiction, we have shown that is irrational.     "
},
{
...
{
  "id": "sec-4-3-3-root-two-5",
  "level": "2",
  "url": "sec-4-3-contradiction.html#sec-4-3-3-root-two-5",
  "type": "Proof",
  "number": "4.3.3.1",
  "title": "",
...
},
{
  ...
  "number": "4.3.1",
  "title": "",
  "body": " Prove:  is irrational.  For the sake of contradicion assume that is rational. That is, it is not true that is irrational. By the definition of rational ( ), we can find two integers and so that and  Calculate:   But, is an integer, thus by the definition of even, is even. Hence, by we can conclude that is even  Thus, by the definition of even we can find an integer so that .  Calculate again:   But is an integer, so, by definition of even, is even, and again by , is even.  Since and , 2 is a common divisor, and thus by definition of greatest common divisor ( ) we have that , yet this means that  Thus we have shown  and  which is a contradiction. Thus by proof by contradiction, we have shown that is irrational.  "
},
{
  ...
  "body": " Biconditional Proofs  Proofs of statments with a biconditional are ubiquitous in mathematics. As you have seen all of our definitons are biconditional statments. We us the biconditional to me mean equivalent. These equivalences in future math classes gives tools for proving conditions without working to more intuitive definitions, instead by giving more usable ones.  You can prove biconditionals in many ways, the one we will take time to examine, is the what I tell my students is the \"safe way\" it is the two-way proof.   Two-Way proof of  biconditional proof  iff proof  if and only if proof   Prove:     Prove:    Therefore,    That this proof method is valid follows from the fact that the following is an equivalence: to verify this equivalence we have the following truth table.             T  T  T  T  T  T    T  F  F  T  F  F    F  T  T  F  F  F    F  F  T  T  T  T     For our next examples we spare the reader the indepth treatement as it is simply two direct proofs.   Prove:  is odd if and only if is even.   Let be an integer  [ ] (if is odd then is even)  Assume is odd. Hence, by definition of odd ( ) we can find an integer so that  Calculate   Since is an integer, by definition of even, is even. Hence by direct proof, if is odd then is even.  [ ] (if is even, then is odd)  Assume is even. Hence, by definition of even we can find an integer such that  Calculate:   Thus, since is an integer, by definition of odd, is odd. Thus by direct proof if is even, then is odd.  Since we showed by direct proof that if is odd then is even and if is even, then is odd, then is odd if and only if  is even.      Prove: For any integer ; is odd if and only if is odd.   Let be arbitrary integer.   (if is odd then is odd)  Assume that is odd, by the definition of odd ( ) we can find an integer so that . Now calculate: since is an integer is odd.   (if is odd then is odd.)  For the sake of contraposition assume that is not odd, thus by we have that is even. By the definition of even we can find an integer so that . Now calculate: since is an integer, we can conclude is even, thus by we have that is not odd. Therefore by contraposition we have that if is odd then is odd.    There is another method for proving an if and only if statement it is not recommended for the student who is just starting their proving journey, but for completness I would be remiss if I did not include it.   One-Way Proof of   iff    iff   ...   iff    iff    The reason I warn beginning students away from this is that too often students get it in there head that the faster way is better, in calculus they see the limit definition for the derivative then learn the power rule and say to themselves well I'm never going back to the limit.  Again for the sake of completion we provide an example, the dilligent hard working student will do their best to see why a backwards proof would be boring .    Prove: For any two integers and ; if and only if    Let and be arbitrary integers, not that     if and only if     if and only if     if and only if     Therefore if and only if     "
},
{
...
},
{
  ...
  "number": "4.4.3",
  "title": "",
  "body": "  Prove: For any integer ; is odd if and only if is odd.   Let be arbitrary integer.   (if is odd then is odd)  Assume that is odd, by the definition of odd ( ) we can find an integer so that . Now calculate: since is an integer is odd.   (if is odd then is odd.)  For the sake of contraposition assume that is not odd, thus by we have that is even. By the definition of even we can find an integer so that . Now calculate: since is an integer, we can conclude is even, thus by we have that is not odd. Therefore by contraposition we have that if is odd then is odd.   "
},
{
...
},
{
  ...
  "body": " Proof by Exhaustion  Our next proof method, is not really a stand-alone method other methods will need to accompany it. We will introduce it using the direct proof as the accompaniment. Proof by cases can also be viewed as specific example of .    What are Cases?  Unlike the example in where the are an unlimited amount of integers to choose from, sometimes we have a finite and more tenable collection of possibilities and we could actually check or prove in each of these situations.  The following is the basic shape of a proof by cases.   Proof by Cases  proof by cases   Case 1: a proof of the first case   Case 2: a proof of the second case      Case n: a proof of the case   At its most basic a proof by cases is an istance of proofs \"Assuming an Or\" from where one is tasked to prove , then we would split the problem into proving as our first case and then as our . For examples of this the reader is reffered to .  Another common place a proof by cases comes up are when we are trying to prove propositons in the form of: for some predicate . There are many common places that proof by cases in the previous form come up, for example the following:    we have either is even or is odd.     either or for some integer      either or      We have already proven that the first point is true in . For the second point, a more general result, we provide the following lemma.    For any two integers and , there exists an such that and      Let and be integers. By the division algorithm from we can find a such that and . Hence subtracting both sides by we get since is an integer by the definition of divides ( ) we have that .        Exhaustive Examples  We now include some examples, the first one is an example of breaking into the cases of even and odd.   Prove: for any integer , is even.   Let be an integer. is either even, or odd.  Case 1: Assume is even.  Hence by definition of even, we can find an integer such that .  Calculate:   Thus, since is an integer, by definition of even, is even. Thus by direct proof, if is even then is even.  Case 2: Assume is odd. Thus by definitino of odd, we can find an integer such that  Calculate   Thus since is an integer, according to the definition of even, is even. Thus by direct proof if is odd then is even.  Thus since case 1 and case 2 hold, by proof by cases, and by direct proof, is even.     Prove: for any integer , if is odd, then there exists an integer so that or   Let be an integer. Assume is odd. By definition of odd we can find an integer such that > Case 1: Assume is even. By definition of even we can find an integer such that . Calculate:  Hence case 1 holds by direct proof.  Case 2: Assume is odd. Thus by definition of odd we can find an integer so taht  Calculate:   Hence case 2 holds by direct proof.  Thus, since case 1 and case 2 hold, by proof by cases, if is odd, then we can find an integer so that or      Prove: For every integer , if then .   Let be an arbitrary integer. For the sake of contrapositive assume that 3 does not divide . By since the only numbers greater than zero and strictly less than 3 are 1 and 2 either or    Case 1: Assume .  By definition of divides we can find an integer so that , hence by adding 1 to both sides of the equation we get . Now calculate: Hence . Since is an integer by definition of divides thus by we have that 3 does not divide    Case 2: Assume .  By definition of divides we can find an integer so that , hence by adding 2 to both sides of the equation we get . Now calculate: Hence . Since is an integer by definition of divides thus by we have that 3 does not divide   Therefore by proof by cases 3 does not divide , and hence by proof by contraposition if then .      "
},
{
  "id": "lem-remainders",
  "level": "2",
...
},
{
  ...
  "number": "4.5.1.1",
  "title": "",
  "body": " Let and be integers. By the division algorithm from we can find a such that and . Hence subtracting both sides by we get since is an integer by the definition of divides ( ) we have that .  "
},
{
  ...
  "number": "4.5.1",
  "title": "",
  "body": " Prove: for any integer , is even.   Let be an integer. is either even, or odd.  Case 1: Assume is even.  Hence by definition of even, we can find an integer such that .  Calculate:   Thus, since is an integer, by definition of even, is even. Thus by direct proof, if is even then is even.  Case 2: Assume is odd. Thus by definitino of odd, we can find an integer such that  Calculate   Thus since is an integer, according to the definition of even, is even. Thus by direct proof if is odd then is even.  Thus since case 1 and case 2 hold, by proof by cases, and by direct proof, is even.   "
},
{
  ...
  "number": "4.5.2",
  "title": "",
  "body": " Prove: for any integer , if is odd, then there exists an integer so that or   Let be an integer. Assume is odd. By definition of odd we can find an integer such that > Case 1: Assume is even. By definition of even we can find an integer such that . Calculate:  Hence case 1 holds by direct proof.  Case 2: Assume is odd. Thus by definition of odd we can find an integer so taht  Calculate:   Hence case 2 holds by direct proof.  Thus, since case 1 and case 2 hold, by proof by cases, if is odd, then we can find an integer so that or   "
},
{
...
},
{
  ...
  "number": "4.6.1",
  "title": "",
  "body": "  Prove: There exists a rational number such that    I now present for your consideration the rational number: One can see that this is indeed a rational number as both 5 and 4 are integers and thus it satisfies the defintion of a rational number ( ). To see that this rational number indeed does the job for our statment notice that so... therefore there truly does exist a rational number so that    "
},
{
...
},
{
  ...
  "number": "4.6.1",
  "title": "",
  "body": " Let and be positive integers. For the sake of contradiction assume that and . By the definition of divides ( ) we can find an integer so that , now since then where 0 is the quotient and is the remainder satisfies the division algorithm ( ), yet since both and are positive the also satisfies the condition of quotient. This is a contradiction as the quotient from the division algorithm is unique.   "
},
{
...
},
{
  ...
  "number": "5.1",
  "title": "What is a Set?",
  "body": " What is a Set?  While set theory has been rigourously defined axiomatically, in this course we choose to only skim the surface using a whole lot of intution and the propositional logic that we devoloped in . The main object of study in set theory is the set . Inutuitively a set is a magic bag filled with stuff... or nothing... Georg Cantor the russian mathematician credited as the father of set theory first defined the set as:  A set is a gathering together into a whole of definite, distinct objects of our perception or of our thought—which are called elements of the set.  We include a much more boring description.   Set  set   A set is a well definied collection of objects.     Element  element  set element  member  set member   The objects in a set are called elements or members .    We will most often denote sets with captial letters like: , , etc. Furthermore we will denote elements with lowercase letters like , , , etc.   Notation  To indicate that is an element of a set we will write: To indicate that is not an element of a set we will write:    Membership to a set is a proposition as it is either true or false.  To define a specific set we can simply list all of it's elements. To do so we encompass the elements we wish to include between braces: and and seperate the elements with a comma.   Consider the following set    and note the following example of the membership notation.   You can also indicate the negation of membership     A set has no order, and you cannot repeat elements.    Cardinality   For a set we call the cardinality or order of is the number of elements in the set , denoted as     In this course we will only mention this concept when the sets are finite, when sets are infinite the cardinality of a set flurishes a beautiful theory, one which we will not dive into in this text but is quite amazing.   Consider the following set   We see that the number of elements in the set is 4 hence, .   Sets come in many different shapes and flavors and throughout your mathematical career you will need to become extremely comfortable with sets and depending on the discipline you will either love or hate the following set but you will never deny that it is perhaps one of the most important sets.   Empty Set  emptyset   We will call the set containing no elements the empty set , we denote the empty set as , that is     As there are no elements in , therefore , as well, to the the disjoy of all combinatorist, the statement is a contradiction (that is always false).   Set Builder Notation  set builder notation  Membership is the defining characteristic of a set, thus it is helpful to define a set by conditions for membership. One way to do that we call set-builder notation .   This is our way of defining membership if and only if is true.   We include some sets defined with set-builder notation.                    In (B) we defined the condition with a quantifier, specifically . This is an extremely common use-case in mathematics. I bring this up here to the student that this is perhaps the most common quantifier to be hidden . That is, we would most likely see it presented as: To defend the mathematician which chooses to present it in this manner, we mostly study objects with a well defined and unique multiplication, that is there is only one unique integer that satisfies for a given .  Adding to the possible confusion yet important to understand, for this same set it is true that that is, by defining a set with an existential condition we are actually defining a universal relationship. To top it off we often do not even mention the universal relationship and hide the existential one, all in the sake of brevity and the word obvious .   "
},
{
  "id": "def-naive-set",
  "level": "2",
  ...
  "number": "5.1.1",
  "title": "Set.",
  "body": " Set  set   A set is a well definied collection of objects.   "
},
{
...
{
  "id": "sec-5-1-what-is-a-set-11",
  "level": "2",
  "url": "sec-5-1-what-is-a-set.html#sec-5-1-what-is-a-set-11",
  "type": "Example",
  "number": "5.1.3",
  "title": "",
...
{
  "id": "sec-5-1-what-is-a-set-12",
  "level": "2",
  "url": "sec-5-1-what-is-a-set.html#sec-5-1-what-is-a-set-12",
  "type": "Note",
  "number": "5.1.4",
  "title": "",
...
},
{
  ...
  "number": "5.1.5",
  "title": "Cardinality.",
  "body": " Cardinality   For a set we call the cardinality or order of is the number of elements in the set , denoted as    "
},
{
  "id": "sec-5-1-what-is-a-set-15",
  "level": "2",
  "url": "sec-5-1-what-is-a-set.html#sec-5-1-what-is-a-set-15",
  "type": "Example",
  "number": "5.1.6",
  "title": "",
...
},
{
  ...
  "body": " Comparing and Combining Sets  Now we will begin comparing sets. Our first tool of comparison is the concept of subset.   Subset  subset  set subset   We say that the set is a subset of a set , denoted , if and only if for all ,     To say that in more plain language, means contains all the elements of , it is noteworthy that may contain more than just those elements from .   Consider the sets    notice that every element from can also be found in , that is .    Define the sets  Notice that since that is, every element of is also an element of .   When a set has exactly the same elements of a set we say those set are equal. The following definition makes this more rigours   Equal Sets  set equal   We say that a set is equal to a set , denoted , if and only if both and   or equivalently by:     Sets are equal exactly when you would think they are, when they are the same set. Yet, as hopefully you have been piecing together in this journey, to prove things like \"they are the same\" we need a bit more rigor and propositional guidance to prove truth. Shortly we will venture into the world of proving with these sets, yet lets take a little time not just to build a rigorous definitions but to build our intuition further.  We now venture into combining sets, that is making new sets given one or more sets.   Union  union  set union   We define the union of two sets and , denoted as the set:     As is done for a set, we must define what it takes for membership to this set. For the union membership is allowed when membership of either or is established. In more common vernacular, this says that the union of two sets is anything from either set.   Consider the following sets    then the union of and is as follows     Define the sets  Thus the union of these two sets is since any real number between -10 and 10 are either included between 0 and 10 or between -10 and 0.   Another way to combine sets is to only consider the elements in which they share, this is our next definition.   Intersection  intersection  set intersection   The intersection of two sets and , denoted , is defined as     Again, as these are sets, we must define what it means to be a member of this set. For the intersection membership is defined for those elements that have membership to both the sets and . Or in other words, the intersection only has the things that are shared between two sets.   Consider the following sets    therefore the intersection of these two sets are   Notice that elements in the intersection are exactly those that show up in both and .    Define the sets  Thus the intersection of these two sets is since those are the only even integers between 0 and 10 (including 10).   The last construction showed where two sets were the same yet, now we explore where they differ.   Difference  difference  set difference   The difference of a set and a set , denoted , is the set defined as     The difference of and consists of the things that are in , but not in .   Consider the sets    thus the set difference of and is   notice that the difference is made up only of elements that appear in yet do not appear in .    Define the sets  Thus the difference of these two sets is since these are there integers between 0 and 10 that are not even.   To end this section we have been quite flipant on our universe of discourse, yet with a well defined one we can look at the set difference involving the universe.   Compliment  compliment  set compliment   The compliment of a set in the universe , is defined as the following set,  or    The compliment can, perhaps, most simply be stated as everything that is not in .   For this example consider the universe of discord as the intergers, , and consider the set of all even numbers, that is the set Then the compliment of is all the integers that are not even, or in-lieu of we have that    "
},
{
  "id": "defn-subset",
  "level": "2",
...
},
{
  ...
  "number": "5.2.9",
  "title": "",
  "body": " Consider the following sets    therefore the intersection of these two sets are   Notice that elements in the intersection are exactly those that show up in both and .  "
},
{
...
},
{
  ...
  "number": "5.2.15",
  "title": "",
  "body": " For this example consider the universe of discord as the intergers, , and consider the set of all even numbers, that is the set Then the compliment of is all the integers that are not even, or in-lieu of we have that   "
},
{
  ...
  "body": " Venn Diagrams and Logic of Sets  Venn diagram  To understand\/describe the relationship between sets we often use a tool known as Venn Diagrams . In simpliest terms a Venn diagram is a drawing representing the sets we are considering, we draw a circle for each set, and imagine the elements are inside the circle. Further, in this section we will use the basic underpinnning of propositional logic to pick apart some logical conclusions from set theory.   John Venn was an English mathematician that in the 1800's introduced Eulerian Circles, which we now dawn with his name.     Venn Diagrams  We now provide some basic examples of Venn diagrams.   A Venn diagram for a singular set      A Venn diagram for     When we are indicating a specific portion of the Venn diagram we will use shading, such as the following examples.   A Venn diagram for      A Venn diagram for      A Venn diagram for      A Venn diagram for     In this chapter's exercises ( ) you will be asked to identify different sets in a Venn diagram. To help the student still attempting to take a grasp of set theory we give a few more creative examples next.   The set:    Here consider the set that contains yet not that, that is in , this is exactly the part that is not shaded, as it is the compliment.    The set:    This time we consider a the place which is neither nor yet is in     The set:    In this example consider the set that avoids where intersects yet does include all of .     The Logic of Sets    To the teacher: Be careful in this section... don't loose them... maybe even skip or just quickly note these? Or perhaps challange the brave student, the student who has been staring deeply into the ripples of the pond to venture here...   As we have built set theory directly from propositonal logic we can approach some basic properties very similiarly to that of and . Now we have the tools to start proving, we begin with the reason that most people hate the empty set.    Let be a set then      To prove this statement, we first fix a universe of discord and a set . Now we examine the defintion of subset; which applied to our secenerio would say, for any  Yet, is a contradiction, that is always false, no matter the element, no matter the universe of discord, as is empty, containing no elements.  So, the proof of this statment falls to the fact that if is a contradiction then for any proposition , the following argument is valid          Of course this means that is a tautology, to see this consider the following truth table.          F  T  T    F  F  T      To reiterate it is this contradiction of which really is sticking point for the emptyset, and why it is always a fringe case that becomes the dismay of mathematicians world round. Next, we present a few more subset conditions.    Let , , and be sets, then the following are true   if and , then       (a) is the argument        hence need that to be a tautology, yet        T  T    F  T      (b) This one is           which is just Hypothetical Syllogism from .   Next we give a somewhat analogous treatment to that of , and leave it to the dilligent reader to draw the direct comparisons.    Let , , and be sets, then the following are true    (commutativity)  (commutativity)  (distributivity)  (distributivity)  (absorption)  (absorption)      (associativity)  (associativity)  iff     In a similiar fashion the following conditions are the consequences of the arguments in .            These final properties are unique to sets, yet have the same logical progressions as the previous ones.          if and only if  if and only if  If then  If then      We leave these last ones without proof, nor the challenge for a hard working reader to try and work it out, but instead we hope the student's intuition will guide them with these last ones.   "
},
{
  "id": "sec-5-3-venn-diagrams-3",
  "level": "2",
  "url": "sec-5-3-venn-diagrams.html#sec-5-3-venn-diagrams-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "Venn Diagrams "
...
},
{
  ...
  "number": "5.3.7",
  "title": "",
  "body": " The set:    Here consider the set that contains yet not that, that is in , this is exactly the part that is not shaded, as it is the compliment.  "
},
{
  ...
  "number": "5.3.8",
  "title": "",
  "body": " The set:    This time we consider a the place which is neither nor yet is in   "
},
{
...
},
{
  ...
  "number": "5.3.2.1",
  "title": "",
  "body": " To prove this statement, we first fix a universe of discord and a set . Now we examine the defintion of subset; which applied to our secenerio would say, for any  Yet, is a contradiction, that is always false, no matter the element, no matter the universe of discord, as is empty, containing no elements.  So, the proof of this statment falls to the fact that if is a contradiction then for any proposition , the following argument is valid          Of course this means that is a tautology, to see this consider the following truth table.          F  T  T    F  F  T     "
},
{
  "id": "prop-a-subset-a",
  "level": "2",
...
},
{
  ...
  "number": "5.3.2.2",
  "title": "",
  "body": " (a) is the argument        hence need that to be a tautology, yet        T  T    F  T      (b) This one is           which is just Hypothetical Syllogism from .  "
},
{
  "id": "prop-set-laws",
  "level": "2",
...
},
{
  ...
  "body": " First Proofs with Sets  In the previous section we looked at many basic propoerties of sets. Now we will venture into some proofs that are more indicative of your furture classes, and return (momentarily) back to the safety of numbers.  We first examine how one would prove a subset to be true.   Proving  Let   ...  Therefore    The keen-eyed student will notice that this is simply the direct proof applied to the definition of subset, specifically: We will see many examples of this proving method throughout out the class, yet before we jump in, I'd like to note for either the instructor or the dilligent student who has been paying very close attention to the journey. I used to try and teach this by taking away the numbers, and instead using the , and the in instead of the now off handed way you see presented here, but I believe the students felt like it was too jarring and then leaned away from subsets and set proofs, which was detremental to their learning once we got to abstract algebra. So now I introduce these proofs with numbers in hopes that you leave the set theory section with the love that you left from the even and odd proofs.   The First Proof  Define the sets   Prove:    Before we begin any proof we sing our song (play-along):  \"What's the ?\"     \"What's the ?\"     \"What're the definitions?\"   The definition of the sets written directly above silly goose!   \"Now, what to do?\"   A direct proof! (proof of a subset!)      To begin this proof we follow our procdure above, by choosing an arbitrary element of the set , using words in the manner of:     Thats all there is to it, we abscond with a random element of , then drudge foward with our journey to show it is a member of .     I chose to begin with this example as is almost identicial to most other of our examples. That is we simply state what it takes for to belong to . From the definition above of the set , we see in the condition part of the set-bulider notation it tells us that there must be an integer so that is 6 times this integer (sound familiar?). To invoke this we could write something like:  By the definition of membership of , we can produce some integer so that .     Now, for the end we need to finally get to the finish line, that is finally conclude that our element is indeed a member of . For this notice that and since 3 is an integer and is an integer we have that is an integer and hence satisfies the condition to be in .  Next, we present it all in one place.   Define the sets   Prove:    Proof:  Let , by definition of the set we can find an integer so that , yet note since we have . Now, since and are integers we can conclude is an integer. Therefore by the definition of the set we have that        More Examples  This is an important concept of your future mathematics courses so we will now provide a couple more abreviated examples of subset.   Consider the sets:     Prove:     We begin by selecting a completley arbitrary element of , which we will denote as . Applying the condition of membership to we can find an integer such that . By factoring we see that and since is an integer we see that satisfies the condition to be a member of .  Therefore, we have chosen an arbitrary , and sucessfully shown that , hence we have shown that .    For our next example we will look at proof involving the intesection ( ).   Consider the sets:      Prove:     We first choose an arbitrary element of in attempts to show it also belongs to , name this element .  Using the definition of the set we see that we can fix a specific so that .  Now, to show membership of the intersection, , we need to show that our element is both a member of  and that it is a member of , by the definition of intersection ( ). Thus we break the remainder of the proof into two parts.   [Membership of ]   Notice that we can factor and as is an integer we see that satisfies the conditions to be a member of .   [Membership of ]   Similarly, notice that we can again factor and as is an integer we see that satisfies the conditions to be a member of .  Finally, since we have chosen a completely arbitray element and then have shown that and that we can conclude that , therefore we have shown that .    Our next example will work through a proof that involves a union ( ).   Consider the sets      Prove:     To start the proof we will choose an arbitrary element of , we will name this random member . By the definition of union ( ) we have that  or  , thus we split our proof in to two cases.   [Case 1: ]   For this first case, assume that , by the condition defining the set we can find an integer such that . Next, we calculate: since is an integer we see that satisfies the condition to be a member of , that is .   [Case 2: ]   For this case we will instead assume . This time by the condition defining the set we can locate a special integer so that . Now we can calculate: and since is an integer we see that, as the condition for membership of is satisfied, .  To wrap-up, since we have chosen a random element and have shown that this same element must have the property that we can conclude that .    Now we will explore the process of showing when sets are equal.   Equals   We say that two sets and are equal , denoted if and only if     Therefore to prove the statment we must have two proofs, one proof for and one proof for .  Our next couple of examples aim to show this.   Consider the set    Prove:     We will again need to break this proof into two parts.   [Want to Show: ]   For the first part, let and hence by the definition of the set we have that , therefore . (this is of course what many refer to as the easy part )   [Want to Show: ]   In this next part, assume . It is now our objective to show membership in , to do such we will need to produce two integers, the way in which we discovered these integers is irrelvant to the proof, so for the sake of argument, lets just assume angels whispered it to me in my sleep.  Notice that since is an integer and as well is an integer, then we can calculate: and hence by the condition of set we have that , therefore .  To wrap-up, since we have shown that both and we may conclude that .     "
},
{
  "id": "sec-5-4-4-end-4",
  "level": "2",
...
{
  "id": "sec-5-5-power-set-5",
  "level": "2",
  "url": "sec-5-5-power-set.html#sec-5-5-power-set-5",
  "type": "Example",
  "number": "5.5.2",
  "title": "",
  "body": " Consider the set:   To build the powerset, it is customary to begin with the empty set, , which we know must be a member of the power set from we know that . Hence,   Next, we will of course need all of the singletons , that is all the sets containing a single element from     Finally, since for any set , as any element of is surely an element of , we have   thus the power set is:   "
},
{
  "id": "sec-5-5-power-set-7",
  "level": "2",
  "url": "sec-5-5-power-set.html#sec-5-5-power-set-7",
  "type": "Example",
  "number": "5.5.3",
  "title": "",
...
{
  "id": "subsec-5-5-1-power-set-first-example-8",
  "level": "2",
  "url": "sec-5-5-power-set.html#subsec-5-5-1-power-set-first-example-8",
  "type": "Example",
  "number": "5.5.1",
  "title": "",
...
},
{
  ...
  "number": "5.6.1",
  "title": "Cross Product.",
  "body": " Cross Product  cross product  cartesian product  set cross product   Given two sets and we can define a new set which we will call the cross prodcut of and (or the cartiesian product ) defined as    "
},
{
...
},
{
  ...
  "number": "5.6.4",
  "title": "",
  "body": " This time if we consider a set I've tried vary hard to stay away from, namely the real numbers, . Then the cartesian plane is the set .  Throughout your youth you have surely seen many points illustrated on this cartiesian plane, such as the elements , , and    "
},
{
...
},
{
  ...
  "number": "5.7.5",
  "title": "",
  "body": " We now illustrate the intersection over a fmaily with Venn diagram below, again, for the family of sets    "
},
{
...
},
{
  ...
  "number": "5.8",
  "title": "Exercises",
  "body": " Exercises     For the sets  , and , for the following draw a Venn diagram shading the appropriate regions                     For the following prove that                      For the following sets write out all elements of both  and                  "
},
{
...
},
{
  ...
  "number": "6.1.1",
  "title": "",
  "body": " For this example we will calcuate some factorials:      "
},
{
  ...
  "body": " Introduction to Induction  We begin with a couple of definitions that are fundamental, yet this technique we are building to is so algorithmic I believe students can become extremely proficient at applying mathematical induction with little found here.   Successor  successor   Let we call the successor of .    In the late 1800's an Italian mathematician Giuseppe Peano deveoloped five axioms which can create all of the basic ordering and arithmetic properties we all know and love of the natural numbers, using an undefined term of successor , our definition of course captures the heart of his construction. Let it be said, Peano did not consider 0 a natural number, but we will forgive him. It is through these axioms which one verifies induction, this is out side the scope of this text but, such a fun exercise for the dedicated reader!   Inductive Set  inductive set   Let , we call an inductive set if and only if has the property     This says that a set is an indcutive set whenever it contains all of its successors.  It is inductive sets that are the underpinning of mathematical induction.   Principle of Mathematical Induction  pmi  induction  principle of mathematical indcution   Let , and let with the following properties:         is an inductive set   Then contains all natural numbers greater than or equal to , that is     In some texts this is referred to as a generalized version of induction, those people also usually follow in the footsteps of Peano and naively assume 0 is not a natural number, we instead give the following example.   Let and assume that both and is an inductive set. By the Principle of Mathematical Induction (PMI) we can conclude that .   It has now been my experience that students have clocked out at this point in the lecture, no matter how much I have promised them that their algorithmic tendencies will be returning. So lets let the rubber hit the road and actual do some proofs!  The basic idea of PMI is to prove that the truth set, , of a predicate is equal to an inductive set. Or to hopefully make this sound less like a riddle,   Proof of  Using PMI  indcution proof  pmi proof  principle of mathematical indcution proof  Proof:    (Base Step) Show that is true     (Induction Assumption) Assume we can find an such that is true     ... thus is true   Therefore such that then is true.   Hopefully you can atleast start to see the algorithm forming, there are 3 steps, and we take these steps every time!   First Proof with Induction  For our first example of indcution we will use a summation ( )   Prove: For any with    Before we begin this proof we sing a slighlty different song for indcution (play-along):  \"What's the ?\"     \"What's the ?\"     \"What're the definitions?\"   summation ( )!   \"Now, what to do?\"   Principle of Mathematical Induction! (it is the point the chapter, also we usually just call it induction )      In Induction we always begin with showing the , in our song we identified the base case as , so for our first step we need to show that is true   (i) (Base Case):  hence ,that is we have shown the base case  After our base case step we use our most crucial step of them all the induction assumption, this is where we just assume it works for some arbitrary number that is at least the size of our base case. For this example I will name that arbitrary number .   (ii) (Induction Assumption):   Assume we can find an such that      The muddle for an induction always has the same purpose an often is done with a calculation. The purpose of the muddle is to satisfy the last part of an induction proof, the case.   (iii)   Now we (the student's favorite word...) calculate       Using Induction the muddle should have always endend with a calculation which showed our desired result. In this example we have shown therefore by proof by indcution we have shown for any with that   QED    "
},
{
  "id": "def-successor",
  "level": "2",
...
},
{
  ...
  "body": " Principle of Mathematical Induction  pmi  induction  principle of mathematical indcution   Let , and let with the following properties:         is an inductive set   Then contains all natural numbers greater than or equal to , that is    "
},
{
  "id": "sec-6-2-intro-to-pmi-10",
  "level": "2",
  "url": "sec-6-2-intro-to-pmi.html#sec-6-2-intro-to-pmi-10",
  "type": "Example",
  "number": "6.2.4",
  "title": "",
...
},
{
  ...
  "number": "6.5.3",
  "title": "",
  "body": " Besides our usual assumptions we will also asssume the properties of inequalities you know and love from you your college algebra course as well (I usually skip these proofs in class but include them for reference to WOP in my later classes)  "
},
{
...
},
{
  ...
  "number": "6.5.1",
  "title": "",
  "body": " Let and be arbitrary integers with and assume that . By definitoin of divides we can find an integer such that . Since we assumed that we ahve that both and . For sake of contradiction assume that , hence hence .  Since then hence thus and hence a contradiction to our assumption that , as specifically .  "
},
{
  "id": "ex-prime-factor",
  "level": "2",
...
},
{
  ...
  "body": " What is a Relation?  A relation at its heart is simple a way of formalizing sentences like: . Slightly more formal, we will take two sets and define how the elements of these sets are related to eachother.   Relations  relation   Let and be sets. is a relation from to if and only if is a subset of That is,   When is a relation from to we say it is a relation on  .     Relation Notation and Verbage  For sets and , with a relation from to when we say:    is -related to      is related via to      is related to (when is understood in the context)     When we will write and when we will write     Since the empty set , is a subset of any set it is a relation from to . As well since any set is a subset of itself, the set is also a relation from to .   At first glance this definition does not seem to match up with our intuition at all, and to add to that the notation may seem very unfamiliar. Our next example hopefully at least motivates the notation.   Lets quickly examine a few relations on the real numbers,     Equals:     means   This relation can be viewed as the graph of       Less than:     means   This relation can be visualized as the following shaded region       While admittedly this is quite a verbose way of explaining something that is already in your lexicon, hoepfully this last example helps calm your stomach or atleast motivate the notation, I would like to now step back and look at this new concept a little more abstractly.   For this example define the following two sets   where consists of some animals from the zoo, and is a set of some foods.  We will now define the relation, as the following subset of    This is the relation of eats . Namely, means  eats  . For example   that is   or it is read\/visualized more like:   Next, to motivate the wordage a relation from  to , we often visualize using what I refer to as the picture, where we draw an arrow from the element in the set to the element in the set it is related to.    For sets and a relation from to does not need use every element of nor every element of , we define the elements it does use.   Domain  relation domain  domain   The domain of the relation from to is the set      Range  relation range  range   The range of a relation is the set      In this example, consider the two sets and and define the relation from to defined as which can be visualized as:   For this relation we have the following and    "
},
{
  "id": "def-relation",
  "level": "2",
...
},
{
  ...
  "body": " New Relations From Old  This subsection is dedicated to making new relations from old ones. Our first method is by turning around the arrows.   Inverse  inverse  relation inverse   If is a relation from to , then the inverse of is the relation      We will consdier the same sets and realtion as in . The inverse is thus which can be visualized as   Notice we have the following domain and range       Let be a relation from to                   Proof of  We will prove part (a) and leave part (b) as an exercise to the reader  Let be a relation from to .   Prove: Dom( ) = Rng( )  Don't forget relations are just sets, and to prove equality of sets, you must prove both subsets!     Let . Hence by definition of domain, we can find such that . Hence, by definition of inverse, . Since , by definition of range, .     Let . Hence, by definition of domain, we can find such that . Hence, by definition of inverse, . Since , by definition of range, .    This next construction is one that may be familiar from your college algebra.   Composite  composition  relation composition   Let be a relation from to , and let be a relation from to . The composite of and is      For this example consider again the sets and but in addition consider the set   and define the relation from to as and define the relation from to as   Thus we can visulaize the composition as   and the relation is thus defined as   Notice we have the following domain and range of the composition     Lets explore a few examples proving using this new concept of composition.   Consider and , relations on , defined as follows:   Prove:      As one must do, we assume what we need to assume, namely assume that and are relations on defined above.  To begin choose an arbitrary element , since and are relations on by defintion of composite we can find an and a such that , such that we can find an integer such that and . By defintion of divides we can find an and such that and . Calculate and since is an integer by the definition of divides we can conclude that , and thus as desired.      Identity Relation  identity  relation identity   For any set , the identity relation on is the set       Let , , and be sets. Let be a realtion from to , a relation from to , and be a relation from to          (composition is associative)     and               Proof of  We will prove part (b) and leave the rest as exercises for the reader.  Suppose that are sets. Let be a relation from , be a relation from , and be a realtion from .  Since we are proving an equality, we will have to prove both subsets.     Let , by defintion of composition, is a relation from to , hence by the definition of relation we can find an and a such that . Now, as well by definition of composition, is a relation from to , and since is a relation from to , we can find a such that and . Again, by the definition of composition, since is a relation from to and is a relation from to we can find such that and .  Since , and then by definiton of composite we have that . And since and then by definition of composite we can conclude that .     For this part, we choose an arbitrary element . Again, by definition of composition is a relation from to and since is a relation from to , hence is a relation from to , hence we can find a and a such that . As well, by the defintion of composite we can find such that and . Yet, by definition if composite since is a relation from to and is a realtion from to we can find such that and . Thus, because and by definition of composite . In a similiar fashion as we also have we can condclude that as desired.  Since we have shown that both and we can conclude that .    "
},
{
  "id": "def-inverse",
  "level": "2",
...
},
{
  ...
  "number": "7.2.2",
  "title": "",
  "body": " We will consdier the same sets and realtion as in . The inverse is thus which can be visualized as   Notice we have the following domain and range    "
},
{
  "id": "prop-dom-inverse",
  "level": "2",
...
},
{
  ...
  "number": "7.2.6",
  "title": "",
  "body": " Consider and , relations on , defined as follows:   Prove:      As one must do, we assume what we need to assume, namely assume that and are relations on defined above.  To begin choose an arbitrary element , since and are relations on by defintion of composite we can find an and a such that , such that we can find an integer such that and . By defintion of divides we can find an and such that and . Calculate and since is an integer by the definition of divides we can conclude that , and thus as desired.    "
},
{
  "id": "def-identity",
  "level": "2",
...
},
{
  ...
  "number": "7.2.8",
  "title": "",
  "body": "  Let , , and be sets. Let be a realtion from to , a relation from to , and be a relation from to          (composition is associative)     and            "
},
{
  ...
  "body": " Proof of  We will prove part (b) and leave the rest as exercises for the reader.  Suppose that are sets. Let be a relation from , be a relation from , and be a realtion from .  Since we are proving an equality, we will have to prove both subsets.     Let , by defintion of composition, is a relation from to , hence by the definition of relation we can find an and a such that . Now, as well by definition of composition, is a relation from to , and since is a relation from to , we can find a such that and . Again, by the definition of composition, since is a relation from to and is a relation from to we can find such that and .  Since , and then by definiton of composite we have that . And since and then by definition of composite we can conclude that .     For this part, we choose an arbitrary element . Again, by definition of composition is a relation from to and since is a relation from to , hence is a relation from to , hence we can find a and a such that . As well, by the defintion of composite we can find such that and . Yet, by definition if composite since is a relation from to and is a realtion from to we can find such that and . Thus, because and by definition of composite . In a similiar fashion as we also have we can condclude that as desired.  Since we have shown that both and we can conclude that .  "
},
{
...
},
{
  ...
  "number": "7.3.5",
  "title": "Symmetric.",
  "body": " Symmetric  symmetric  relation symmetric  We say that a realtion on a set is symmetric on whenever   "
},
{
...
},
{
  ...
  "body": " Equivalence Relation  equivalence relation  relation equivalence relation   A relation on a set is an equivalence relation on if is reflexive, symmetric, and trasitive on .   "
},
{
...
},
{
  ...
  "number": "7.5",
  "title": "Functions",
  "body": " Functions  Functions are important no matter the field you go into, and you have had a lot of experience with functions up to this point. Lets now formalize the definiton of function as a specific type of relation.   Function  function  mapping  function domain  mapping domain  function codomain  mapping codomain  codomain   A function , or mapping , from to is a relation from to such that:    The domain of is .    If and then     For a function we write We say  or   The set is called the codomain of .  In the case where , we say that   When , we write .    At first glance condition (ii) may look forign to you, yet in your calculus and college algebra class you probably just called this the horizontal line test, seen in this next example.   We saw that equals was a relation at the beginning of this chapter in , indeed it is also a function. To use it in the our new context of functions, define the function as    Notice that where we choose to draw a horizontal line is the choice of an element of the domain of , i.e. an element of , and the condition that the horizontal line only hits the graph once is the condition the f(x) has only one output, as is condition (ii) of being a function.    Notice that the eats relation from is not a function as both   and   So lets condsider a slightly different relation, by putting the turtle on a diet, defined as the following   Now it makes sense to use the of notation of functions because for example there is only one way to write the folowing:     Consider the relation from to defined as  Prove:  is a function    To prove that is a function we need to show the two conditions of being a function.   Condition (i)   The first condition is an equality of sets, per usual we will split this into two parts     Let by definition of we have that as desired. (the room chants obviously! )     Let , then by definition of , as desired.  Since we have shown both and we can conclude . Therefore we have shown that satisfies condition (i) of being a function.   Condition (ii)   Assume and , hence by defintion of we have that and that hence as desired.  Since we have shown both conditions to be a function we can conclude that is a function.     The jump from relations to functions can be jarring to students especially with all of the corresponding notations, we take a momemnt now and attempt to make sense of them.   Functions VS Relations  Let and be sets, and consider a function .  At the root a function is just a relation and hence   Instead of wrting or we write , moreover we most often don't write the , that is we have .  To put this context of realtions once again (and hopefully not make it too much more convoluted) we have and perhaps the most labyrinthine interpretation where represents the relation and is the element of related to via .    The next concepts come up over and over again in algebra, analysis and topology.   Image  image  function image   Let , and let , The image of (or image set ) is defined as        Consider the following set    and the subset    Now define the funciton as follows   Then we can visulaize the image of , , as follows     Inverse Image  inverse image  function inverse image   Let , and let , The inverse image of (or inverse image set ) is defined as        The inverse image should not be confused with the inverse relation.    Consider the same set and function from . This time define the subset as   We can then visualize the preimage of , , as follows.      Let and be subsets of , and and be subsets of .                 Proof of   Proof of (a)   Let . Thus by definition of image, we can find a such that . By definition of intersect, and . Since , by definition of image, as well. Since , by definition of image, . Thus, by definition of intersection, .   Proof of (b)   To show equality we should as usual break it into two parts.     Let . Thus by definition of inverse image, . Thus by definition of intersection, and . By definition of inverse image, and . Hence, by definition of intersection, .     Let hence by definition of intersection and . By definition of inverse image we have that both and hence by defintion of intersection we have that . Therefore by definition of preimage we have that as desired.  Since we have shown and we can thus conclude    Lets end this section with a couple more examples of proofs involing these new concepts.   Let and    Prove:    Let . By the definition of image, we can find such that . By definition of inverse image, . Thus, since we have that , therefore .     Let , and let , , , and .   Prove: .   As this is a proof of equality of sets we should break the proof into two pieces.     Let . By defintion of difference, and . By definition of inverse image, and . By definition of difference, . Thus, by definition of inverse image, .     Let by definition of inverse image , by definition of difference and hence by definition of inverse image and , thus by definition of difference   Since we have shown both and we can conclude     "
},
{
  "id": "def-function",
  "level": "2",
...
},
{
  ...
  "number": "7.5.3",
  "title": "",
  "body": " Notice that the eats relation from is not a function as both   and   So lets condsider a slightly different relation, by putting the turtle on a diet, defined as the following   Now it makes sense to use the of notation of functions because for example there is only one way to write the folowing:   "
},
{
  "id": "ex-is-a-function",
  "level": "2",
...
},
{
  ...
  "number": "7.5.6",
  "title": "",
  "body": " Consider the following set    and the subset    Now define the funciton as follows   Then we can visulaize the image of , , as follows   "
},
{
...
},
{
  ...
  "number": "7.6.3",
  "title": "",
  "body": " Consider the function from defined as  Prove:  is surjective    The definition of surjective envolves an equality of sets, so we break our proof into two parts.     Let by definition of range we can find an such that , yet by definition of we have that , since both and are integers we can conclude that is an integer and thus as desired.     Let , by we can find two integers and such that such that . Since we have that or or , splitting our proof into 3 cases   Case 1: Assume   In this case since and 0 is also an integer we have that hence and thus as desired.   Case 2: Assume   For this case note that hence and -1 are integers we have that hence thus as desired.   Case 3: Assume   In this case since and 1 are integers we have that hence , therfore as desired.  Because we have shown no matter what is that we can conclude that   Since we have shown both and we can conclude , therefore we have shown that is surjective.    "
},
{
...
},
{
  ...
  "number": "7.6.7",
  "title": "",
  "body": " Consider the function defined for any as  Prove:  is an injective function.    We leave the task of proving that is indeed a function to the reader, and we prove that is injective.  Let and such that by definiton of this means , subtracting five on both sides of the equation gives us as desired.    "
},
{
...
},
{
  ...
  "body": " Proof of  As we are to prove a bijconditional we will split the proof into two parts.     Assume is one-to-one. We have defined the inverse of a relation in , so what we want to show is that is a function. To show a relation is a function we need to show that it satisfies both conditions to being a function.   Proof of Condition (i):   This first condition is the equality of sets, namely this was proven in .   Proof of Condition (ii)   Let , and such that and . By definition of inverse, and . Thus, by our assumption, as desired.     Let and such that . Name this element . By definition of inverse, and . Thus, by our assumption that is a function by condition (i) of being a function we have, as desired.  "
},
{
  "id": "def-bijection",
  "level": "2",
...
},
{
  ...
  "number": "7.6.12",
  "title": "",
  "body": " Consider the function defined for any as  Prove:  is a bijection.    To show this function is a bijection we will need to show it injective and surjective.   Proof of one-to-one:   Let and be two arbitrary integers, such that by definition of we have that and therefore , adding two to both sides of the equations leaves us with as desired.   Proof of onto:   To show our desired equality of sets we split into two parts.     Let , by definition of range we can find an integer such that by the definiton of we have that , since both and 2 are integers we have that is an integer and hence as desired.     Let , note to show that we have membership of we need to produce an integer so that maps this new integer to . This is an existential, and the way we produce this element in unimportant to the proof. Notice that since and 2 are integers we have that is an integer, and notice that and hence by definition of range we have that as desired.  Because we have shown that and we can conclude that , therefore we have that is onto as desired.  Since we have shown that is both one-to-one and onto we have that is a bijection.    "
},
{
  "id": "prop-bij-comp",
  "level": "2",
...
},
{
  ...
  "number": "7.7",
  "title": "Exercises",
  "body": " Exercises     Rng( ) = Dom( )     and           is a reflexive relation on if and only if .     is symmetric if and only if .    Suppose that and are equivalence relations on a set . Prove that is an equivalence relation on .    Prove that if is a symmetric, transitive relation on , and the domain of is , then is reflexive on .    Let be a relation on the set . Prove that is symmetric.    If is onto and is onto , then is onto .    Let and . If is one-to-one, then is one-to-one.    Let and . If is one-to-one and onto , then if and only if or .                   Prove that defines a surjective functio from to but not injective.     "
},
{
  "id": "backmatter-2",
  "level": "1",
